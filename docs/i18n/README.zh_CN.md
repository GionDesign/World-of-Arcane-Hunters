...
**官方网站：https://world.arcanehunters.com/**
...
[立即游玩](https://world.arcanehunters.com/) · [搭建你自己的世界](#host-your-own-world-one-command) · [训练智能体](#train-an-agent-headless-rl) · [Web3](#web3) · [参与贡献](CONTRIBUTING.zh_CN.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft 是一款完整的经典时代 MMO：你现在就能在浏览器里直接游玩，用一条命令自行搭建，甚至还能训练 AI 智能体来玩它。它免费、开源，并已在 [world.arcanehunters.com](https://world.arcanehunters.com/) 上线运行。
...
关于代币的更多信息见 [world.arcanehunters.com](https://world.arcanehunters.com/)。
