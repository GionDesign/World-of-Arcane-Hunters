...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'World of Arcane Hunters 官方網站',
  'seo.officialBody':
    'Eastbrook 伺服器的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
  ...
  'playerCard.shareText':
    '我正在 World of Arcane Hunters 中鑄就傳說：{level}級 {className}{tierBit}。加入我的伺服器：',
  ...
  'controls.chat': '開啟對話框',
  'seo.title': 'World of Arcane Hunters：經典風格網頁 MMO',
  'seo.description':
    '在 World of Arcane Hunters 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人遊戲',
  ...
  'a11y.githubProject': '開啟 World of Arcane Hunters 的 GitHub 專案',
  'a11y.discordCommunity': '加入 World of Arcane Hunters 的 Discord 社群',
  'a11y.donateProject': '捐贈支持 World of Arcane Hunters',
  ...
  'mobilePreflight.iosOpenStep': '從新的主畫面圖示開啟 World of Arcane Hunters。',
  ...
  'entities.mobs.custom_scorchwing_wyvern.name': '焦翼翼龍',
  'entities.mobs.custom_blighted_sentinel.name': '腐蝕哨兵',
  'entities.mobs.custom_dragonclaw_warden.name': '龍爪守衛',
  'entities.mobs.custom_ignaraxis.name': '永恆的伊格納拉克斯',
  'entities.mobs.custom_skullfire_brute.name': '顱焰蠻兵',
  'entities.mobs.custom_blightshroud_stalker.name': '瘟霧潛襲者',
  'entities.mobs.custom_ironpelt_monkroose.name': '鐵皮僧鼬',
  'entities.npcs.custom_commander_vael.name': '瓦爾指揮官',
  'entities.npcs.custom_commander_vael.title': '腐蝕之地軍官',
  'entities.npcs.custom_commander_vael.greeting': '做好準備，{playerName}。這片腐蝕之地不曾入眠，我們也不會。',
  'entities.npcs.custom_scout_fenris.name': '偵察員芬里斯',
  'entities.npcs.custom_scout_fenris.title': '腐蝕之地偵察員',
  'entities.npcs.custom_scout_fenris.greeting': '你穿越了翼龍地帶？很好。我需要像你這樣有能力的人。',
  'entities.npcs.custom_elder_draxis.name': '長老德拉克西斯',
  'entities.npcs.custom_elder_draxis.title': '屠龍者',
  'entities.npcs.custom_elder_draxis.greeting': '我獵龍已三十年，{playerName}。伊格納拉克斯與眾不同。',
  'entities.quests.custom_proving_ground.title': '證明之地',
  'entities.quests.custom_proving_ground.text': '灰行德雷克已推進到我們營地邊緣，{playerName}。削減它們的數量——殺死十只——證明你屬於腐蝕之地。',
  'entities.quests.custom_proving_ground.completion': '十只德雷克倒下了。不錯。你或許真能在這裡活下去，{playerName}。',
  'entities.quests.custom_proving_ground.objectives.0.label': '擊殺灰行德雷克',
  'entities.quests.custom_marks_of_the_drake.title': '德雷克的印記',
  'entities.quests.custom_marks_of_the_drake.text': '德雷克鱗片堅硬如板甲，{playerName}。我需要八片來裝備下一支巡邏隊。德雷克們不會輕易放手——能取多少就取多少。',
  'entities.quests.custom_marks_of_the_drake.completion': '八片鱗片。這些比我們能鍛造的任何東西都更耐火。幹得好。',
  'entities.quests.custom_marks_of_the_drake.objectives.0.label': '灰行德雷克鱗片',
  'entities.quests.custom_into_the_blight.title': '進入腐蝕之地',
  'entities.quests.custom_into_the_blight.text': '那些焦翼翼龍正在我們和地下城之間築巢，{playerName}。需要消滅八隻，同時我需要五顆它們的心石給指揮官的煉金師。它們躲得很深，但我知道你能找到它們。',
  'entities.quests.custom_into_the_blight.completion': '巢穴已清除。那些心石將比你想象的對我們更有價值。',
  'entities.quests.custom_into_the_blight.objectives.0.label': '擊殺焦翼翼龍',
  'entities.quests.custom_into_the_blight.objectives.1.label': '焦翼心石',
  'entities.quests.custom_eye_of_the_storm.title': '風暴之眼',
  'entities.quests.custom_eye_of_the_storm.text': '腐蝕哨兵是伊格納拉克斯的外圍守衛，{playerName}。古老的龍族在那生物附近被數百年扭曲了。擊倒三隻，帶來它們核心中的腐蝕餘燼。如果你能對付它們，你就準備好進入龍顎了。',
  'entities.quests.custom_eye_of_the_storm.completion': '三隻哨兵倒下，餘燼在手。你準備好了，{playerName}。回到駐地去找長老德拉克西斯。他等待這一刻已經很久了。',
  'entities.quests.custom_eye_of_the_storm.objectives.0.label': '擊殺腐蝕哨兵',
  'entities.quests.custom_eye_of_the_storm.objectives.1.label': '腐蝕餘燼',
  'entities.quests.custom_eternal_flame.title': '永恆之焰',
  'entities.quests.custom_eternal_flame.text': '永恆的伊格納拉克斯在龍顎中沉睡了數個時代，{playerName}。我們頭頂的腐蝕之地就是他的呼吸具象化的形態。進入龍顎，在他的巢穴中面對他，終結這一切。你的同伴將是必要的——這不是一個人的狩獵。',
  'entities.quests.custom_eternal_flame.completion': '永恆之焰已熄滅，{playerName}。我等待三十年才能說出這些話。腐蝕之地將會消退。拿著這個——你絕對值得。',
  'entities.quests.custom_eternal_flame.objectives.0.label': '擊殺永恆的伊格納拉克斯',
  'entities.quests.custom_blight_patrol.title': '腐蝕之地巡邏',
  'entities.quests.custom_blight_patrol.text': '我們不能讓德雷克和翼龍淹沒通道，{playerName}。巡邏腐蝕之地，擊殺十五隻德雷克和八隻翼龍，然後回來報告。確保我們的側翼安全，同時讓指揮系統處理更大的局面。',
  'entities.quests.custom_blight_patrol.completion': '側翼安全。當有人出去發揮作用時，士兵們呼吸更暢快。幹得好，{playerName}。',
  'entities.quests.custom_blight_patrol.objectives.0.label': '擊殺灰行德雷克',
  'entities.quests.custom_blight_patrol.objectives.1.label': '擊殺焦翼翼龍',
  'entities.zones.custom_dragons_blight.name': '龍之腐蝕之地',
  'entities.zones.custom_dragons_blight.welcome': '龍之腐蝕之地在你面前延伸，被灰燼和遠古火焰的回聲所籠罩。',
  'entities.zones.custom_dragons_blight.pois.0.label': '腐蝕之地哨所',
  'entities.zones.custom_dragons_blight.pois.1.label': '芬里斯前哨',
  'entities.zones.custom_dragons_blight.pois.2.label': '龍顎',
  'entities.dungeons.custom_dragons_maw.name': '龍顎',
  'entities.dungeons.custom_dragons_maw.enterText': '熱浪令人窒息。前方的黑暗中有龐大的東西在蠕動。',
  'entities.dungeons.custom_dragons_maw.leaveText': '你從龍顎中走出，外面的空氣冰冷地拂過皮膚。',
  ...
  'mode.play': '開始遊戲',
  'mode.playAria': '遊玩 World of Arcane Hunters',
  ...
  'entities.items.custom_drake_scale.name': '灰行蜉蝣鱗',
  'entities.items.custom_wyvern_heartstone.name': '暗翼翼龍心石',
  'entities.items.custom_blight_ember.name': '腐蝕餘燼',
  'entities.items.custom_drakebone_shoulders.name': '蜉蝣龍骨護肩',
  'entities.items.custom_scorchwing_cowl.name': '焦翼兜帽',
  'entities.items.custom_blight_stalkers_hood.name': '腐蝕獵手頭巾',
  'entities.items.custom_ignaraxis_greatblade.name': '伊格納拉克斯巨刃',
  'entities.items.custom_cinderstave_eternal.name': '永恆灰燼法杖',
  'entities.items.custom_fang_of_ignaraxis.name': '伊格納拉克斯之牙',
  ...
  'guide.worldPage.intro':
    'World of Arcane Hunters 是一片你需徒步橫越的連綿大地，三大區域由南向北排列。沒有快速旅行，所以旅程本身就是冒險的一部分。',
  ...
  'hudChrome.discord.swag.titleChampion': '稱號：Eastbrook 勇士',
