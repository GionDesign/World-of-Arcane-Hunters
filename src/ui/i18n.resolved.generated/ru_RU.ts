...
export const ru_RU: EnTranslations = {
  ...
  "guide": {
    ...
    "worldPage": {
      "heading": "Мир",
      "intro": "World of Arcane Hunters - это единый цельный край, который вы пересекаете пешком, три зоны, протянувшиеся с юга на север. Здесь нет быстрых перемещений, так что дорога - это часть приключения.",
      "hub": "Опорная база",
  ...
  "mode": {
    ...
    "play": "Играть",
    "playAria": "Играть в World of Arcane Hunters",
  ...
  "seo": {
    "title": "World of Arcane Hunters: веб-MMO в классическом стиле",
    "description": "Отправьтесь в эпическое приключение в World of Arcane Hunters, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.",
    "genre": "MMORPG",
  ...
  "a11y": {
    ...
    "githubProject": "Открыть проект World of Arcane Hunters на GitHub",
    "discordCommunity": "Присоединиться к Discord-сообществу World of Arcane Hunters",
    "donateProject": "Пожертвовать на поддержку World of Arcane Hunters"
  },
  "loading": {
    "world": "Загрузка мира...",
  ...
  "mobilePreflight": {
    ...
    "iosOpenStep": "Откройте World of Arcane Hunters через новый значок на домашнем экране.",
    ...
    "androidOpenStep": "Откройте World of Arcane Hunters через новый значок.",
  ...
  "serverUnavailable": {
    "title": "World of Arcane Hunters - мир недоступен",
    "logoAlt": "World of Arcane Hunters",
    "eyebrow": "Технические работы",
    "heading": "Мир временно недоступен.",
    "body": "Мы перезапускаем игровой сервис и ожидаем, что Eastbrook скоро вернется. Эта страница продолжит проверку автоматически.",
  ...
  "entities": {
    ...
    "items": {
      ...
      "custom_drake_scale": {
        "name": "Чешуя Пепельного Дрейка"
      },
      "custom_wyvern_heartstone": {
        "name": "Сердечный Камень Темнокрылого Виверна"
      },
      "custom_blight_ember": {
        "name": "Губительный Уголек"
      },
      "custom_drakebone_shoulders": {
        "name": "Наплечники из Костей Дрейка"
      },
      "custom_scorchwing_cowl": {
        "name": "Капюшон Опаленнокрылого"
      },
      "custom_blight_stalkers_hood": {
        "name": "Капюшон Губительного Охотника"
      },
      "custom_ignaraxis_greatblade": {
        "name": "Великий Клинок Игнараксиса"
      },
      "custom_cinderstave_eternal": {
        "name": "Посох Вечного Пепла"
      },
      "custom_fang_of_ignaraxis": {
        "name": "Клык Игнараксиса"
      },
      "bristleback_maul": {
    ...
    "npcs": {
      ...
      "custom_commander_vael": {
        "name": "Командир Ваэль",
        "title": "Офицер Стражи Гибели",
        "greeting": "Будьте готовы, {playerName}. Эта Гибель не спит, и мы тоже."
      },
      "custom_scout_fenris": {
        "name": "Разведчик Фенрис",
        "title": "Разведчик Стражи Гибели",
        "greeting": "Вы прошли через территорию виvernов? Хорошо. Мне нужен кто-то умелый здесь."
      },
      "custom_elder_draxis": {
        "name": "Старейшина Дракcис",
        "title": "Охотник на Драконов",
        "greeting": "Я охочусь на драконов тридцать лет, {playerName}. Игнараксис не такой, как другие."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "quests": {
      ...
      "custom_proving_ground": {
        "title": "Испытательный Полигон",
        "text": "Пепельные Дрейки продвинулись к краям нашего лагеря, {playerName}. Проредите их ряды — убейте десять — и докажите, что вы достойны Гибели.",
        "completion": "Десять Дрейков пали. Неплохо. Возможно, вы и правда выживете здесь, {playerName}.",
        "objectives": {
          "0": {
            "label": "Пепельные Дрейки убиты"
          }
        }
      },
      "custom_marks_of_the_drake": {
        "title": "Знаки Дрейка",
        "text": "Чешуя Дрейков прочна, как латы, {playerName}. Мне нужно восемь штук, чтобы снарядить следующий патруль. Дрейки не отдают их легко — берите, что можете.",
        "completion": "Восемь чешуй. Они выдержат огонь лучше всего, что мы можем выковать. Отличная работа.",
        "objectives": {
          "0": {
            "label": "Чешуя Пепельного Дрейка"
          }
        }
      },
      "custom_into_the_blight": {
        "title": "В Глубь Гибели",
        "text": "Эти Опаленнокрылые Вивернь вьют гнезда между нами и подземельем, {playerName}. Нужно уничтожить восемь из них, и мне нужно пять их сердечных камней для алхимика командира. Они прячутся глубоко, но я знаю, что вы доберетесь.",
        "completion": "Гнездовище расчищено. Эти сердечные камни окажутся ценнее, чем вы думаете.",
        "objectives": {
          "0": {
            "label": "Опаленнокрылые Вивернь убиты"
          },
          "1": {
            "label": "Сердечные Камни Опаленнокрылых"
          }
        }
      },
      "custom_eye_of_the_storm": {
        "title": "Глаз Бури",
        "text": "Зараженные Стражи — внешняя охрана Игнараксиса, {playerName}. Древние драконорожденные, искаженные веками рядом с этим существом. Повергните трех и принесите мне мерцающие угольки из их сердцевины. Если справитесь с ними, вы готовы к Пасти.",
        "completion": "Три стража пали, и угольки в руках. Вы готовы, {playerName}. Возвращайтесь на пост и поговорите со Старейшиной Дракcисом. Он долго ждал этого момента.",
        "objectives": {
          "0": {
            "label": "Зараженные Стражи убиты"
          },
          "1": {
            "label": "Губительные Угольки"
          }
        }
      },
      "custom_eternal_flame": {
        "title": "Вечное Пламя",
        "text": "Игнараксис Вечный дремлет в Драконьей Пасти целую эпоху, {playerName}. Гибель над нами — это его дыхание, принявшее форму. Войдите в Пасть, встретьте его в логове и покончите с этим. Ваши товарищи будут необходимы — это не охота для одного.",
        "completion": "Вечное Пламя угасло, {playerName}. Я ждал тридцать лет, чтобы сказать эти слова. Гибель теперь рассеется. Возьмите это — вы заслужили.",
        "objectives": {
          "0": {
            "label": "Игнараксис Вечный убит"
          }
        }
      },
      "custom_blight_patrol": {
        "title": "Патруль Гибели",
        "text": "Мы не можем позволить Дрейкам и Виvernям захватить подходы, {playerName}. Патрулируйте Гибель, уничтожьте пятнадцать Дрейков и восемь Виvernей, затем доложите. Держите наши фланги чистыми, пока командование разбирается с большой картиной.",
        "completion": "Фланги в безопасности. Солдаты дышат легче, когда кто-то выходит и что-то делает. Отличная работа, {playerName}.",
        "objectives": {
          "0": {
            "label": "Пепельные Дрейки убиты"
          },
    ...
    "zones": {
      ...
      "custom_dragons_blight": {
        "name": "Драконья Гибель",
        "welcome": "Драконья Гибель простирается перед вами, задушенная пеплом и далеким эхом древнего огня.",
        "pois": {
          "0": {
            "label": "Пост Стражи Гибели"
          },
          "1": {
            "label": "Аванпост Фенриса"
          },
          "2": {
            "label": "Драконья Пасть"
          }
        }
      }
    },
    "dungeons": {
      ...
      "custom_dragons_maw": {
        "name": "Драконья Пасть",
        "enterText": "Жара невыносима. Что-то огромное шевелится во тьме впереди.",
        "leaveText": "Вы выходите из Драконьей Пасти, наружный воздух холодит кожу."
      },
      "drowned_temple": {
        "name": "Утонувший храм",
