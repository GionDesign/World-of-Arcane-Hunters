...
**Official website: https://world.arcanehunters.com/**
...
[Play now](https://world.arcanehunters.com/) · [Host your own world](#host-your-own-world-one-command) · [Train an agent](#train-an-agent-headless-rl) · [Web3](#web3) · [Contributing](CONTRIBUTING.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft is a complete classic-era MMO you can play right now in your browser, host yourself with one command, and even train AI agents to play. It is free, open source, and live at [world.arcanehunters.com](https://world.arcanehunters.com/).
...
More on the token at [world.arcanehunters.com](https://world.arcanehunters.com/).
