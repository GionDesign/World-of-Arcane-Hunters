...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.mobs.custom_ashwalker_drake.name': 'Askrypare Draken',
  'entities.mobs.custom_scorchwing_wyvern.name': 'Brivingevivern',
  'entities.mobs.custom_blighted_sentinel.name': 'Forvitrad Vaktpost',
  'entities.mobs.custom_dragonclaw_warden.name': 'Drakklovan Vardare',
  'entities.mobs.custom_ignaraxis.name': 'Ignaraxis den Evige',
  'entities.mobs.custom_skullfire_brute.name': 'Skalleldsbuse',
  'entities.mobs.custom_blightshroud_stalker.name': 'Blightsloja Jagare',
  'entities.mobs.custom_ironpelt_monkroose.name': 'Jarnskinn Monkroose',
  'entities.npcs.custom_commander_vael.name': 'Befalhavare Vael',
  'entities.npcs.custom_commander_vael.title': 'Officer i Blight-vakten',
  'entities.npcs.custom_commander_vael.greeting': 'Var beredd, {playerName}. Denna Blight sover inte, och inte vi heller.',
  'entities.npcs.custom_scout_fenris.name': 'Spanare Fenris',
  'entities.npcs.custom_scout_fenris.title': 'Spanare i Blight-vakten',
  'entities.npcs.custom_scout_fenris.greeting': 'Gick du igenom wyvernterritoriet? Bra. Jag behövde nagon kapabel har.',
  'entities.npcs.custom_elder_draxis.name': 'Aldste Draxis',
  'entities.npcs.custom_elder_draxis.title': 'Drakdodare',
  'entities.npcs.custom_elder_draxis.greeting': 'Jag har jagat drakar i trettio ar, {playerName}. Ignaraxis ar annorlunda an de andra.',
  'entities.quests.custom_proving_ground.title': 'Provningsfalt',
  'entities.quests.custom_proving_ground.text': 'Askrypardrakarna har avancerat till kanten av vart lager, {playerName}. Minska deras antal -- tio av dem -- och bevisa att du hor hemma i Blight.',
  'entities.quests.custom_proving_ground.completion': 'Tio drakar fallda. Inte illa. Kanske overlever du har, {playerName}.',
  'entities.quests.custom_proving_ground.objectives.0.label': 'Askrypare Drakar Doda',
  'entities.quests.custom_marks_of_the_drake.title': 'Drakmärken',
  'entities.quests.custom_marks_of_the_drake.text': 'Drakfjäll ar lika harda som plattrustning, {playerName}. Jag behover atta stycken for nasta patrullbefal. Drakarna ger inte upp dem latt -- ta vad du kan.',
  'entities.quests.custom_marks_of_the_drake.completion': 'Atta fjäll. De klarar eld battre an nagot vi kan smida. Bra jobbat.',
  'entities.quests.custom_marks_of_the_drake.objectives.0.label': 'Askrypare Drakfjäll',
  'entities.quests.custom_into_the_blight.title': 'In i Blight',
  'entities.quests.custom_into_the_blight.text': 'De dar brivingevivernerna hakar sig fast mellan oss och fangelset, {playerName}. Atta av dem maste bort, och jag behover fem av deras hjartstenar till befalets alkemist. De sitter djupt inne, men jag vet att du kan na dem.',
  'entities.quests.custom_into_the_blight.completion': 'Boet har rensats. De har hjartstenarnas ar mer varda an du tror.',
  'entities.quests.custom_into_the_blight.objectives.0.label': 'Brivinge Vivernar Doda',
  'entities.quests.custom_into_the_blight.objectives.1.label': 'Vivern Hjartstenar',
  'entities.quests.custom_eye_of_the_storm.title': 'Stormens Oga',
  'entities.quests.custom_eye_of_the_storm.text': 'De forvitrader vakterna ar Ignaraxis yttre skydd, {playerName}. Uraldriga drakvarelser vridna av arhundraden nara det vasendet. Sla ned tre av dem och ta med mig de fordarvade gloden fran deras karnor. Om du klarar av dem ar du redo for Kakorna.',
  'entities.quests.custom_eye_of_the_storm.completion': 'Tre vakter falla och glod i hand. Du ar redo, {playerName}. Ga och prata med Aldste Draxis vid fortet. Han har vantat lange pa det har.',
  'entities.quests.custom_eye_of_the_storm.objectives.0.label': 'Forvitrader Vakter Doda',
  'entities.quests.custom_eye_of_the_storm.objectives.1.label': 'Fordärvade Glod',
  'entities.quests.custom_eternal_flame.title': 'Den Eviga Lagan',
  'entities.quests.custom_eternal_flame.text': 'Ignaraxis den Evige har sovit i Drakgapet en era, {playerName}. Blighten over oss ar hans anda given form. Ga in i Gapet, mott honom i hans lya och avsluta det. Dina kamrater kommer att behovas -- detta ar ingen jakt for en ensam person.',
  'entities.quests.custom_eternal_flame.completion': 'Den Eviga Lagan har slackts, {playerName}. Jag har vantat trettio ar pa att saga de orden. Blighten kommer nu att ebba ut. Ta det har -- du har forjanat det med besked.',
  'entities.quests.custom_eternal_flame.objectives.0.label': 'Ignaraxis den Evige Dod',
  'entities.quests.custom_blight_patrol.title': 'Blight-patrull',
  'entities.quests.custom_blight_patrol.text': 'Vi kan inte lata drakarna och vivernarna oversvamma tillfarterna, {playerName}. Patrullera Blighten, doda femton drakar och atta vivernar, och atervänd. Det haller vara flanker fria medan befalskedjan hanterar den storre bilden.',
  'entities.quests.custom_blight_patrol.completion': 'Flankerna ar fria. Männen andas lattare nar nagon ar dar ute och gor skillnad. Bra jobbat, {playerName}.',
  'entities.quests.custom_blight_patrol.objectives.0.label': 'Askrypare Drakar Doda',
  'entities.quests.custom_blight_patrol.objectives.1.label': 'Brivinge Vivernar Doda',
  'entities.zones.custom_dragons_blight.name': 'Drakforbannelsen',
  'entities.zones.custom_dragons_blight.welcome': 'Drakforbannelsen stracker sig framfor dig, kvavd av aska och det langa ekoet av urforntidig eld.',
  'entities.zones.custom_dragons_blight.pois.0.label': 'Blight-vaktens Fort',
  'entities.zones.custom_dragons_blight.pois.1.label': 'Fenris Forvakt',
  'entities.zones.custom_dragons_blight.pois.2.label': 'Drakgapet',
  'entities.dungeons.custom_dragons_maw.name': 'Drakgapet',
  'entities.dungeons.custom_dragons_maw.enterText': 'Varmen ar kvavande. Nagot massivt ror sig i morkret framfor dig.',
  'entities.dungeons.custom_dragons_maw.leaveText': 'Du kommer ut ur Drakgapet, utomhusluften kylig mot din hud.',
  'entities.items.custom_drake_scale.name': 'Askrypare Drakfjäll',
  'entities.items.custom_wyvern_heartstone.name': 'Brivinge Hjartsten',
  'entities.items.custom_blight_ember.name': 'Fordärvat Glod',
  'entities.items.custom_drakebone_shoulders.name': 'Drakknogle Axelstycken',
  'entities.items.custom_scorchwing_cowl.name': 'Brivinge Kapa',
  'entities.items.custom_blight_stalkers_hood.name': 'Blightjagare Huva',
  'entities.items.custom_ignaraxis_greatblade.name': 'Ignaraxis Svardsblad',
  'entities.items.custom_cinderstave_eternal.name': 'Evig Askstav',
  'entities.items.custom_fang_of_ignaraxis.name': 'Ignaraxis Huggtand',
};
