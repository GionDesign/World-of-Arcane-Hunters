...
**공식 웹사이트: https://world.arcanehunters.com/**
...
[지금 플레이](https://world.arcanehunters.com/) · [직접 세계 호스팅하기](#host-your-own-world-one-command) · [에이전트 훈련하기](#train-an-agent-headless-rl) · [Web3](#web3) · [기여하기](CONTRIBUTING.ko_KR.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft는 지금 바로 브라우저에서 플레이할 수 있고, 명령어 하나로 직접 호스팅할 수 있으며, 심지어 AI 에이전트를 훈련시켜 플레이하게 할 수도 있는 완성된 클래식 시대 MMO입니다. 무료이고, 오픈 소스이며, [world.arcanehunters.com](https://world.arcanehunters.com/)에서 실시간으로 운영됩니다.
...
토큰에 대한 더 자세한 내용은 [world.arcanehunters.com](https://world.arcanehunters.com/)에 있습니다.
