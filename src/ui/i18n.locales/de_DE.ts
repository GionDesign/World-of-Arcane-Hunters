...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.defaultRealm': 'Welt von Arcane Hunters',
  ...
  'playerCard.shareText':
    'Ich schmiede meine Legende in World of Arcane Hunters: Stufe {level} {className}{tierBit}. Tretet meinem Realm bei:',
  'playerCard.nativeShareTitle': 'Welt von Arcane Hunters',
  ...
  'seo.title': 'World of Arcane Hunters: Klassisches Web-MMO',
  'seo.description':
    'Begib dich in World of Arcane Hunters auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'World of Arcane Hunters-Projekt auf GitHub öffnen',
  'a11y.discordCommunity': 'Der World of Arcane Hunters-Community auf Discord beitreten',
  'a11y.donateProject': 'Spenden, um World of Arcane Hunters zu unterstützen',
  ...
  'mobilePreflight.iosOpenStep':
    'Öffne World of Arcane Hunters über das neue Symbol auf dem Home-Bildschirm.',
  ...
  'mobilePreflight.androidOpenStep': 'Öffne World of Arcane Hunters über das neue Symbol.',
  ...
  'serverUnavailable.title': 'World of Arcane Hunters - Realm nicht verfügbar',
  ...
  'serverUnavailable.body':
    'Wir starten den Spieldienst neu und erwarten, dass Eastbrook bald zurückkehrt. Diese Seite prüft automatisch weiter.',
  ...
  'entities.mobs.custom_ashwalker_drake.name': 'Aschlaufer-Drache',
  'entities.mobs.custom_scorchwing_wyvern.name': 'Sengflugel-Wyvern',
  'entities.mobs.custom_blighted_sentinel.name': 'Verseucher Wachter',
  'entities.mobs.custom_dragonclaw_warden.name': 'Drachenklauen-Huter',
  'entities.mobs.custom_ignaraxis.name': 'Ignaraxis der Ewige',
  'entities.mobs.custom_skullfire_brute.name': 'Schadelflammen-Grobian',
  'entities.mobs.custom_blightshroud_stalker.name': 'Seuchenmantel-Stalker',
  'entities.mobs.custom_ironpelt_monkroose.name': 'Eisenpelz-Monkrose',
  'entities.npcs.custom_commander_vael.name': 'Befehlshaber Vael',
  'entities.npcs.custom_commander_vael.title': 'Seuchenwacht-Offizier',
  'entities.npcs.custom_commander_vael.greeting': 'Seid bereit, {playerName}. Diese Seuche schlaft nicht, und wir auch nicht.',
  'entities.npcs.custom_scout_fenris.name': 'Spaher Fenris',
  'entities.npcs.custom_scout_fenris.title': 'Seuchenwacht-Spaher',
  'entities.npcs.custom_scout_fenris.greeting': 'Ihr habt euch durch das Wyvern-Gebiet geschlagen? Gut. Ich konnte hier jemand Fahiges gebrauchen.',
  'entities.npcs.custom_elder_draxis.name': 'Altester Draxis',
  'entities.npcs.custom_elder_draxis.title': 'Drachentöter',
  'entities.npcs.custom_elder_draxis.greeting': 'Ich habe dreißig Jahre lang Drachen gejagt, {playerName}. Ignaraxis ist anders als die anderen.',
  'entities.quests.custom_proving_ground.title': 'Bewahrungsprufung',
  'entities.quests.custom_proving_ground.text': 'Die Aschlaufer-Drachen haben sich bis an den Rand unseres Lagers vorgearbeitet, {playerName}. Lichtet ihre Reihen -- zehn von ihnen -- und beweist, dass ihr in der Seuche bestehen konnt.',
  'entities.quests.custom_proving_ground.completion': 'Zehn Drachen gefallen. Nicht schlecht. Ihr werdet hier vielleicht uberleben, {playerName}.',
  'entities.quests.custom_proving_ground.objectives.0.label': 'Aschlaufer-Drachen getotet',
  'entities.quests.custom_marks_of_the_drake.title': 'Zeichen des Drachen',
  'entities.quests.custom_marks_of_the_drake.text': 'Drachenschuppen sind so hart wie Plattenrustung, {playerName}. Ich brauche acht davon, um den nachsten Patrol auszurusten. Die Drachen geben sie nicht leicht her -- nehmt, was ihr konnt.',
  'entities.quests.custom_marks_of_the_drake.completion': 'Acht Schuppen. Diese halten Feuer besser stand als alles, was wir schmieden konnen. Gute Arbeit.',
  'entities.quests.custom_marks_of_the_drake.objectives.0.label': 'Aschlaufer-Drachenschuppen',
  'entities.quests.custom_into_the_blight.title': 'In die Seuche',
  'entities.quests.custom_into_the_blight.text': 'Diese Sengflugel-Wyvern nisten zwischen uns und dem Dungeon, {playerName}. Acht von ihnen mussen weg, und ich brauche funf ihrer Herzsteine fur den Alchemisten des Befehlshabers. Sie sind tief, aber ich weiß, dass ihr sie erreichen konnt.',
  'entities.quests.custom_into_the_blight.completion': 'Das Nestgebiet ist frei. Diese Herzsteine werden uns mehr wert sein, als ihr denkt.',
  'entities.quests.custom_into_the_blight.objectives.0.label': 'Sengflugel-Wyvern getotet',
  'entities.quests.custom_into_the_blight.objectives.1.label': 'Sengflugel-Herzsteine',
  'entities.quests.custom_eye_of_the_storm.title': 'Auge des Sturms',
  'entities.quests.custom_eye_of_the_storm.text': 'Die Verseuchten Wachter sind Ignaraxis außere Garde, {playerName}. Uralte Drachenkin, entstellt durch Jahrhunderte in der Nahe dieses Wesens. Schlagt drei von ihnen nieder und bringt mir die Seuchenkohlen aus ihren Kernen. Wenn ihr sie bealtigen konnt, seid ihr bereit fur den Schlund.',
  'entities.quests.custom_eye_of_the_storm.completion': 'Drei Wachter fallen, Kohlen in der Hand. Ihr seid bereit, {playerName}. Geht zuruck zum Posten und sprecht mit Altesten Draxis. Er hat lange auf diesen Moment gewartet.',
  'entities.quests.custom_eye_of_the_storm.objectives.0.label': 'Verseuchte Wachter getotet',
  'entities.quests.custom_eye_of_the_storm.objectives.1.label': 'Seuchenkohlen',
  'entities.quests.custom_eternal_flame.title': 'Die Ewige Flamme',
  'entities.quests.custom_eternal_flame.text': 'Ignaraxis der Ewige hat ein Zeitalter lang im Drachenschlund geschlummert, {playerName}. Die Seuche uber uns ist sein Atem, der Form angenommen hat. Betritt den Schlund, stellt euch ihm in seiner Hohle und macht dem ein Ende. Eure Gefahrten werden notwendig sein -- das ist keine Jagd fur einen allein.',
  'entities.quests.custom_eternal_flame.completion': 'Die Ewige Flamme ist erloschen, {playerName}. Dreißig Jahre habe ich gewartet, um diese Worte zu sagen. Die Seuche wird sich nun legen. Nehmt dies -- ihr habt es mehr als verdient.',
  'entities.quests.custom_eternal_flame.objectives.0.label': 'Ignaraxis der Ewige getotet',
  'entities.quests.custom_blight_patrol.title': 'Seuchenpatrouille',
  'entities.quests.custom_blight_patrol.text': 'Wir konnen nicht zulassen, dass die Drachen und Wyvern die Zugange uberrennen, {playerName}. Patrouilliert die Seuche, schlagt funfzehn Drachen und acht Wyvern nieder und meldet euch zuruck. Halt unsere Flanken frei, wahrend die Befehlskette das großere Bild handhabt.',
  'entities.quests.custom_blight_patrol.completion': 'Flanken sind frei. Die Manner atmen leichter, wenn jemand da draußen den Unterschied macht. Gute Arbeit, {playerName}.',
  'entities.quests.custom_blight_patrol.objectives.0.label': 'Aschlaufer-Drachen getotet',
  'entities.quests.custom_blight_patrol.objectives.1.label': 'Sengflugel-Wyvern getotet',
  'entities.zones.custom_dragons_blight.name': 'Drachenseuche',
  'entities.zones.custom_dragons_blight.welcome': 'Die Drachenseuche erstreckt sich vor euch, erstickt von Asche und dem fernen Echo uralten Feuers.',
  'entities.zones.custom_dragons_blight.pois.0.label': 'Seuchenwacht-Posten',
  'entities.zones.custom_dragons_blight.pois.1.label': 'Fenris Außenposten',
  'entities.zones.custom_dragons_blight.pois.2.label': 'Drachenschlund',
  'entities.dungeons.custom_dragons_maw.name': 'Drachenschlund',
  'entities.dungeons.custom_dragons_maw.enterText': 'Die Hitze ist erstickend. Etwas Riesiges regt sich in der Dunkelheit vor euch.',
  'entities.dungeons.custom_dragons_maw.leaveText': 'Ihr taucht aus dem Drachenschlund auf, die Außenluft kalt gegen eure Haut.',
  ...
  'mode.play': 'Spielen',
  'mode.playAria': 'World of Arcane Hunters spielen',
  ...
  'guide.worldPage.intro':
    'World of Arcane Hunters ist ein zusammenhängendes Land, das du zu Fuß durchquerst, drei Gebiete von Süden nach Norden gereiht. Es gibt keine Schnellreise, die Reise selbst ist also Teil des Abenteuers.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion von Eastbrook',
