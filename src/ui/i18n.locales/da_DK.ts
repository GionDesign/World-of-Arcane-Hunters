...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.mobs.custom_ashscale_whelp.name': 'Askeskæl-drage',
  'entities.mobs.custom_cinderclaw_raptor.name': 'Gloedklo-raptor',
  'entities.mobs.custom_blightfire_elemental.name': 'Forbandelsesild-elementar',
  'entities.mobs.custom_scorchveil_spider.name': 'Brændsløredderkop',
  'entities.mobs.custom_ironwing_gargoyle.name': 'Jernvinge-gargoyle',
  'entities.mobs.custom_blight_ghoul.name': 'Forbandelsesghul',
  'entities.mobs.custom_moltenscale_basilisk.name': 'Smeltsskæl-basilisk',
  'entities.mobs.custom_ignaraxis.name': 'Ignaraxis den Evigbrændende',
  'entities.npcs.custom_warden_thessaly.name': 'Vogter Thessaly',
  'entities.npcs.custom_warden_thessaly.title': 'Dragebanes Vogternes Orden',
  'entities.npcs.custom_warden_thessaly.greeting':
    'En anden eventyrer... Pas dig, fremmed. Drakenforbandelsen sluger disse lande. Vi har brug for stærke vaabenfæller, ikke svage sjæle.',
  'entities.quests.custom_blight_awakening.title': 'Forbandelsens Opvagnen',
  'entities.quests.custom_blight_awakening.text':
    'Drakenforbandelsens ondskab breder sig fra Ignaraxis tilbedelse af disse lande. Dræb askeskæl-drage og cinderklo-raptorer for at dæmme op for trusselen.',
  'entities.quests.custom_blight_awakening.completion':
    'Du har gjort mere end de fleste tør. Forbandelsens flammer er en smule svagere nu, men Ignaraxis venter endnu.',
  'entities.quests.custom_blight_awakening.objectives.slay_whelps': 'Dræb askeskæl-drage (0/5)',
  'entities.quests.custom_blight_awakening.objectives.slay_raptors': 'Dræb cinderklo-raptorer (0/3)',
  'entities.quests.custom_ignaraxis_bounty.title': 'Ignaraxis Dusøren',
  'entities.quests.custom_ignaraxis_bounty.text':
    'Ordenen udbyder en dusør for Ignaraxis den Evigbrændendes hoved. Den evige drage har fortæret tre af vores bedste vaabenfæller. Bevis din værd.',
  'entities.quests.custom_ignaraxis_bounty.completion':
    'Det kan ikke lade sig gøre... og alligevel er det sket. Du har fældet det udødelige uhyre. Ordenen ærer dig, helt.',
  'entities.quests.custom_ignaraxis_bounty.objectives.slay_ignaraxis': 'Dræb Ignaraxis (0/1)',
  'entities.zones.custom_dragons_blight.name': 'Drakenforbandelsen',
  'entities.zones.custom_dragons_blight.welcome': 'Du træder ind i Drakenforbandelsen',
  'entities.zones.custom_dragons_blight.poi_ashveil_ruins': 'Asksløret Ruiner',
  'entities.zones.custom_dragons_blight.poi_ember_sanctum': 'Gloedhelligdommen',
  'entities.zones.custom_dragons_blight.poi_ignaraxis_lair': 'Ignaraxis Hule',
  'entities.dungeons.custom_dragons_maw.name': 'Dragensgabet',
  'entities.dungeons.custom_dragons_maw.enterText': 'Du er nu inde i Dragensgabet.',
  'entities.dungeons.custom_dragons_maw.leaveText': 'Du forlader Dragensgabet.',
  'entities.items.custom_drake_scale.name': 'Askevandrer Drageskæl',
  'entities.items.custom_wyvern_heartstone.name': 'Brændvinge Hjertesten',
  'entities.items.custom_blight_ember.name': 'Forbandelsesglød',
  'entities.items.custom_drakebone_shoulders.name': 'Drakeknogle-skulderpanser',
  'entities.items.custom_scorchwing_cowl.name': 'Brændvinge-hætte',
  'entities.items.custom_blight_stalkers_hood.name': 'Forbandelsesstalkers hætte',
  'entities.items.custom_ignaraxis_greatblade.name': 'Ignaraxis Storklinge',
  'entities.items.custom_cinderstave_eternal.name': 'Den Evige Gloedstav',
  'entities.items.custom_fang_of_ignaraxis.name': 'Ignaraxis Tand',
};
