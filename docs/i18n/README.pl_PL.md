...
**Oficjalna strona: https://world.arcanehunters.com/**
...
[Zagraj teraz](https://world.arcanehunters.com/) · [Postaw własny świat](#host-your-own-world-one-command) · [Wytrenuj agenta](#train-an-agent-headless-rl) · [Web3](#web3) · [Współtworzenie](CONTRIBUTING.pl_PL.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft to kompletne MMO w stylu klasycznej ery, w które możesz zagrać już teraz w przeglądarce, postawić je samodzielnie jedną komendą, a nawet wytrenować agentów AI, by w nie grali. Jest darmowe, open source i dostępne na żywo pod adresem [world.arcanehunters.com](https://world.arcanehunters.com/).
...
Więcej o tokenie na [world.arcanehunters.com](https://world.arcanehunters.com/).
