...
**Site oficial: https://world.arcanehunters.com/**
...
[Jogar agora](https://world.arcanehunters.com/) · [Hospede seu próprio mundo](#host-your-own-world-one-command) · [Treine um agente](#train-an-agent-headless-rl) · [Web3](#web3) · [Contribuindo](CONTRIBUTING.pt_BR.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft é um MMO completo da era clássica que você pode jogar agora mesmo no seu navegador, hospedar sozinho com um único comando e até usar para treinar agentes de IA para jogar. É gratuito, open source e está no ar em [world.arcanehunters.com](https://world.arcanehunters.com/).
...
Mais sobre o token em [world.arcanehunters.com](https://world.arcanehunters.com/).
