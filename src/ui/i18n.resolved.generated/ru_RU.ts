...
export const ru_RU: EnTranslations = {
  ...
  "entities": {
    ...
    "items": {
      ...
      "custom_ember_core": {
        "name": "Тлеющее ядро углей"
      },
      "custom_magma_pelt": {
        "name": "Опалённая шкура магмовой гончей"
      },
      "custom_cinder_tusk": {
        "name": "Клык пепельного тролля"
      },
      "custom_slag_fragment": {
        "name": "Шлаковый осколок"
      },
      "custom_ash_bone": {
        "name": "Кость из пепла"
      },
      "custom_blaze_reaver": {
        "name": "Огненный сокрушитель"
      },
      "custom_inferno_staff": {
        "name": "Инфернальный посох"
      },
      "custom_cinderfang_dagger": {
        "name": "Кинжал угольного клыка"
      },
      "custom_fire_resistance_potion": {
        "name": "Зелье сопротивления огню"
      },
      "custom_charred_ration": {
        "name": "Обугленный полевой паёк"
      }
    },
    "mobs": {
      "forest_wolf": {
      ...
      "custom_magma_hound": {
        "name": "Магмовая гончая"
      },
      "custom_cinder_troll": {
        "name": "Угольный тролль"
      },
      "custom_flamecaller": {
        "name": "Призыватель пламени"
      },
      "custom_molten_colossus": {
        "name": "Расплавленный колосс"
      },
      "ironvein_foreman": {
    ...
    "npcs": {
      ...
      "custom_warden_cael": {
        "name": "Страж Каэль",
        "title": "Командор заставы Пепельного дозора",
        "greeting": "Жаровня с каждым часом становится опаснее. Нам нужна каждая пара рук."
      },
      "tidewatcher_ondrel": {
        "name": "Ондрел Вейн",
    ...
    "quests": {
      ...
      "custom_q_quench_the_elementals": {
        "title": "Усмирить элементалей",
        "text": "Лавовые элементали вырываются из трещин и отрезают наши линии снабжения. Уничтожьте 10 из них и принесите 5 угольных ядер в качестве доказательства. Будьте осторожны -- они испускают жар в агонии.",
        "completion": "Хорошая работа. Трещины пока успокоились. Эти ядра могут пригодиться нашим мастерам.",
        "objectives": {
          "0": {
            "label": "Уничтоженных лавовых элементалей"
          },
          "1": {
            "label": "Собранных угольных ядер"
          }
        }
      },
      "custom_q_hound_culling": {
        "title": "Стая гончих",
        "text": "Магмовые гончие рыщут по западному хребту и нападают на наших разведчиков. Уничтожьте 8 из них и соберите их шкуры. Шкура огнеупорна -- мы можем использовать её для починки доспехов.",
        "completion": "Эти шкуры подойдут. Наш кожевник подготовит их перед следующим патрулем.",
        "objectives": {
          "0": {
            "label": "Убитых магмовых гончих"
          },
          "1": {
            "label": "Шкуры магмовых гончих"
          }
        }
      },
      "custom_q_troll_tide": {
        "title": "Нашествие троллей",
        "text": "Угольные тролли собираются на севере. Они захватили старый огненный алтарь, и мы не можем этого допустить. Убейте 6 угольных троллей и принесите мне 4 их клыка в качестве трофеев.",
        "completion": "Алтарь снова наш. Хорошая работа.",
        "objectives": {
          "0": {
            "label": "Убитых угольных троллей"
          },
          "1": {
            "label": "Клыки угольных троллей"
          }
        }
      },
      "q_mogger": {
    ...
    "zones": {
      ...
      "custom_cinderhold": {
        "name": "Жаровня",
        "welcome": "Жар накрывает вас ещё до того, как рассеивается дым. Добро пожаловать в Жаровню.",
        "pois": {
          "0": {
            "label": "Пепельный дозор"
          },
          "1": {
            "label": "Западный хребет"
          },
          "2": {
            "label": "Пепельный алтарь"
          },
          "3": {
            "label": "Логово Колосса"
          }
        }
      }
    },
