...
export const DICT: Record<string, Record<string, string>> = {
  en: {
    ...
    'world.entered': '{name} has entered World of Arcane Hunters.',
  ...
  es: {
    ...
    'world.entered': '{name} ha entrado en World of Arcane Hunters.',
  ...
  fr_FR: {
    ...
    'world.entered': '{name} a rejoint World of Arcane Hunters.',
  ...
  fr_CA: {
    ...
    'guild.rankOfficer': 'un officier',
    'guild.rankMember': 'un membre',
    'world.entered': '{name} est entré dans World of Arcane Hunters.',
    'world.left': '{name} a quitté le monde. ({reason})',
    'world.leaveLogout': 'déconnexion',
    'world.leaveDisconnect': 'déconnecté',
  ...
  it_IT: {
    ...
    'world.entered': '{name} è entrato in World of Arcane Hunters.',
  ...
  de_DE: {
    ...
    'world.entered': '{name} hat World of Arcane Hunters betreten.',
  ...
  zh_CN: {
    ...
    'guild.rankMember': '会员',
    'world.entered': '{name}进入了World of Arcane Hunters。',
  ...
  zh_TW: {
    ...
    'guild.rankMember': '成員',
    'world.entered': '{name} 進入了 World of Arcane Hunters。',
  ...
  ko_KR: {
    ...
    'world.entered': '{name}님이 World of Arcane Hunters에 입장했습니다.',
  ...
  ja_JP: {
    ...
    'world.entered': '{name}がWorld of Arcane Huntersに参加しました。',
  ...
  pt_BR: {
    ...
    'world.entered': '{name} entrou em World of Arcane Hunters.',
  ...
  ru_RU: {
    ...
    'world.entered': '{name} входит в World of Arcane Hunters.',
...
const RULES: Rule[] = [
  ...
  {
    re: /^(.+) has entered World of Arcane Hunters\.$/,
