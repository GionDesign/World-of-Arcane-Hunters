...
**Officiel hjemmeside: https://world.arcanehunters.com/**
...
[Spil nu](https://world.arcanehunters.com/) · [Hav din egen verden](#host-your-own-world-one-command) · [Træn en agent](#train-an-agent-headless-rl) · [Web3](#web3) · [Bidrag](CONTRIBUTING.da_DK.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft er en komplet MMO i klassisk stil, som du kan spille lige nu i din browser, selv hoste med en enkelt kommando, og endda træne AI-agenter til at spille. Den er gratis, open source, og live på [world.arcanehunters.com](https://world.arcanehunters.com/).
...
Mere om token'et på [world.arcanehunters.com](https://world.arcanehunters.com/).
