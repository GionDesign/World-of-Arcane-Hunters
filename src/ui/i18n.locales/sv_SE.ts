...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  'entities.npcs.auctioneer_voss.greeting':
    'World of Arcane Hunters-marknaden är öppen även här, {className}. Köp från varje äventyrare i riket, eller lägg ut dina egna varor.',
  ...
  'a11y.discordCommunity': 'Gå med i World of Arcane Hunters-gemenskapen på Discord',
  'a11y.donateProject': 'Donera för att stödja World of Arcane Hunters',
  'a11y.githubProject': 'Öppna GitHub-projektet World of Arcane Hunters',
  ...
  'guide.worldPage.intro':
    'World of Arcane Hunters är ett enda sammanhängande land som du korsar till fots, tre zoner lagda från söder till norr. Det finns ingen snabbresa, så resan är en del av äventyret.',
  ...
  'mobilePreflight.androidOpenStep': 'Öppna World of Arcane Hunters från den nya ikonen.',
  ...
  'mobilePreflight.iosOpenStep': 'Öppna World of Arcane Hunters från den nya Hemskärmsikonen.',
  ...
  'mode.play': 'Spela',
  'mode.playAria': 'Spela World of Arcane Hunters',
  ...
  'playerCard.defaultRealm': 'World of Arcane Hunters',
  ...
  'playerCard.nativeShareTitle': 'World of Arcane Hunters',
  ...
  'playerCard.shareText':
    'Jag skapar min legend i World of Arcane Hunters: Nivå {level} {className}{tierBit}. Gå med i min värld:',
  ...
  'seo.description':
    'Ge dig ut på ett episkt äventyr i World of Arcane Hunters, en klassiskt inspirerad mikro-MMO som du spelar direkt i din webbläsare. Anslut till en beständig delad värld, höj nivå på klasser och besegra fiender!',
  'seo.genre': 'MMORPG',
  'seo.officialLabel': 'Officiell webbplats för World of Arcane Hunters',
  'seo.operatingSystem': 'Webbläsare',
  'seo.playMode': 'Flerspelarläge',
  'seo.title': 'World of Arcane Hunters: Klassiskt inspirerad webb-MMO',
  'serverUnavailable.body':
    'Vi startar om speltjänsten och förväntar oss att Eastbrook är tillbaka inom kort. Den här sidan fortsätter att kontrollera automatiskt.',
  ...
  'serverUnavailable.title': 'World of Arcane Hunters - Riket otillgängligt',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion of Eastbrook',
