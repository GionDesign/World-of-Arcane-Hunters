...
export const en = {
  ...
  entities: {
    ...
    items: {
      ...
      custom_ember_core: { name: "Smoldering Ember Core" },
      custom_magma_pelt: { name: "Scorched Magma Hound Pelt" },
      custom_cinder_tusk: { name: "Cinder Troll Tusk" },
      custom_slag_fragment: { name: "Slag Fragment" },
      custom_ash_bone: { name: "Ash Bone" },
      custom_blaze_reaver: { name: "Blaze Reaver" },
      custom_inferno_staff: { name: "Inferno Staff" },
      custom_cinderfang_dagger: { name: "Cinderfang Dagger" },
      custom_fire_resistance_potion: { name: "Fire Resistance Potion" },
      custom_charred_ration: { name: "Charred Field Ration" },
    },
