...
**Sito ufficiale: https://world.arcanehunters.com/**
...
[Gioca ora](https://world.arcanehunters.com/) · [Ospita il tuo mondo](#host-your-own-world-one-command) · [Addestra un agente](#train-an-agent-headless-rl) · [Web3](#web3) · [Contribuisci](CONTRIBUTING.it_IT.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft è un MMO completo in stile classico che puoi giocare proprio ora nel tuo browser, ospitare da solo con un unico comando e su cui puoi persino addestrare agenti IA a giocare. È gratuito, open source e attivo su [world.arcanehunters.com](https://world.arcanehunters.com/).
...
Maggiori informazioni sul token su [world.arcanehunters.com](https://world.arcanehunters.com/).
