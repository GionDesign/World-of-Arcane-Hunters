...
**Resmi web sitesi: https://world.arcanehunters.com/**
...
[Hemen oyna](https://world.arcanehunters.com/) · [Kendi dünyanı barındır](#host-your-own-world-one-command) · [Bir ajan eğit](#train-an-agent-headless-rl) · [Web3](#web3) · [Katkıda bulun](CONTRIBUTING.tr_TR.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft, şu anda tarayıcında oynayabileceğin, tek bir komutla kendin barındırabileceğin ve hatta oynaması için yapay zeka ajanları eğitebileceğin eksiksiz, klasik dönem tarzı bir MMO oyunudur. Ücretsiz, açık kaynaklı ve [world.arcanehunters.com](https://world.arcanehunters.com/) adresinde canlı.
...
Jeton hakkında daha fazla bilgi: [world.arcanehunters.com](https://world.arcanehunters.com/).
