...
export const fr_CA: EnTranslations = {
  ...
  "seo": {
    ...
    "description": "Partez à l'aventure dans World of Arcane Hunters, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
    "genre": "MMORPG",
  ...
  "serverUnavailable": {
    ...
    "body": "Nous redémarrons le service de jeu et Eastbrook devrait revenir sous peu. Cette page continuera de vérifier automatiquement.",
