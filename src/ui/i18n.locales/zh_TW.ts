...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.mobs.custom_lava_elemental.name": "熔岩元素",
  "entities.mobs.custom_ember_imp.name": "火焰小鬼",
  "entities.mobs.custom_magma_hound.name": "岩漿獵犬",
  "entities.mobs.custom_cinder_troll.name": "煤渣巨魔",
  "entities.mobs.custom_flamecaller.name": "召火者",
  "entities.mobs.custom_molten_colossus.name": "熔融巨人",
  "entities.npcs.custom_warden_cael.name": "守護者卡爾",
  "entities.npcs.custom_warden_cael.title": "餘燼哨站指揮官",
  "entities.npcs.custom_warden_cael.greeting": "炽焰坑每時每刻都愈發危險。我們需要每一雙能幹的手。",
  "entities.quests.custom_q_quench_the_elementals.title": "鎮壓元素",
  "entities.quests.custom_q_quench_the_elementals.text": "熔岩元素正從裂縫中湧出，切斷了我們的補給線。消滅10隻並帶回5個餘燼核心作為證明。小心——它們瀕死時會噴發熱浪。",
  "entities.quests.custom_q_quench_the_elementals.completion": "幹得好。裂縫似乎暫時平靜下來了。這些核心對我們的工匠或許有用。",
  "entities.quests.custom_q_quench_the_elementals.objectives.0.label": "消滅的熔岩元素",
  "entities.quests.custom_q_quench_the_elementals.objectives.1.label": "收集的餘燼核心",
  "entities.quests.custom_q_hound_culling.title": "獵犬種群",
  "entities.quests.custom_q_hound_culling.text": "岩漿獵犬一直在西部山脊遊蕩並襲擊我們的斥候。消滅8隻並收集它們的毛皮。這種皮質耐火——我們可以用來修補鎧甲。",
  "entities.quests.custom_q_hound_culling.completion": "這些毛皮很不錯。我們的皮革匠會在下次巡邏前將它們處理好。",
  "entities.quests.custom_q_hound_culling.objectives.0.label": "擊殺的岩漿獵犬",
  "entities.quests.custom_q_hound_culling.objectives.1.label": "岩漿獵犬毛皮",
  "entities.quests.custom_q_troll_tide.title": "巨魔潮",
  "entities.quests.custom_q_troll_tide.text": "煤渣巨魔正在北部集結。他們佔據了古老的火焰神祠，我們不能讓他們守住它。殺死6隻煤渣巨魔，並帶回4根他們的獠牙作為戰利品。",
  "entities.quests.custom_q_troll_tide.completion": "神祠再度歸我們所有。幹得好。",
  "entities.quests.custom_q_troll_tide.objectives.0.label": "擊殺的煤渣巨魔",
  "entities.quests.custom_q_troll_tide.objectives.1.label": "煤渣巨魔獠牙",
  "entities.zones.custom_cinderhold.name": "炽焰坑",
  "entities.zones.custom_cinderhold.welcome": "煙霧散去之前，熱浪已先行來襲。歡迎來到炽焰坑。",
  "entities.zones.custom_cinderhold.pois.0.label": "餘燼哨站",
  "entities.zones.custom_cinderhold.pois.1.label": "西部山脊",
  "entities.zones.custom_cinderhold.pois.2.label": "灰燼神祠",
  "entities.zones.custom_cinderhold.pois.3.label": "巨人巢穴",
  // Cinderhold custom items
  "entities.items.custom_ember_core.name": "熾熱灰燼核心",
  "entities.items.custom_magma_pelt.name": "焦烤熔岩獵犬毛皮",
  "entities.items.custom_cinder_tusk.name": "煤渣巨魔獠牙",
  "entities.items.custom_slag_fragment.name": "爐渣碎片",
  "entities.items.custom_ash_bone.name": "灰燼骸骨",
  "entities.items.custom_blaze_reaver.name": "烈焰巨刃",
  "entities.items.custom_inferno_staff.name": "地獄法杖",
  "entities.items.custom_cinderfang_dagger.name": "焰牙匕首",
  "entities.items.custom_fire_resistance_potion.name": "火焰抵抗藥水",
  "entities.items.custom_charred_ration.name": "炭化野戰口糧",
};
