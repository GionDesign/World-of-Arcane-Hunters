...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.defaultRealm': 'Arcane Huntersの世界',
  ...
  'playerCard.nativeShareTitle': 'Arcane Huntersの世界',
  ...
  'entities.mobs.custom_ashwalker_drake.name': '灰行きドレイク',
  'entities.mobs.custom_scorchwing_wyvern.name': '焦げ翼ワイバーン',
  'entities.mobs.custom_blighted_sentinel.name': '疫病の番人',
  'entities.mobs.custom_dragonclaw_warden.name': '竜爪の守護者',
  'entities.mobs.custom_ignaraxis.name': '永遠なるイグナラクシス',
  'entities.mobs.custom_skullfire_brute.name': '頭蓋炎のブルート',
  'entities.mobs.custom_blightshroud_stalker.name': '疫病紗の潜伏者',
  'entities.mobs.custom_ironpelt_monkroose.name': '鉄皮のモンクルーズ',
  'entities.npcs.custom_commander_vael.name': 'ヴェール司令官',
  'entities.npcs.custom_commander_vael.title': 'ブライトウォッチ士官',
  'entities.npcs.custom_commander_vael.greeting': '準備せよ、{playerName}。このブライトは眠らない、我々もだ。',
  'entities.npcs.custom_scout_fenris.name': '斥候フェンリス',
  'entities.npcs.custom_scout_fenris.title': 'ブライトウォッチ斥候',
  'entities.npcs.custom_scout_fenris.greeting': 'ワイバーンの縄張りを抜けたか？よし。有能な者が必要だった。',
  'entities.npcs.custom_elder_draxis.name': '長老ドラクシス',
  'entities.npcs.custom_elder_draxis.title': '竜殺し',
  'entities.npcs.custom_elder_draxis.greeting': '私は三十年ドラゴンを狩ってきた、{playerName}。イグナラクシスは他とは違う。',
  'entities.quests.custom_proving_ground.title': '試練の地',
  'entities.quests.custom_proving_ground.text': '灰行きドレイクが我々の野営地の縁まで押し寄せている、{playerName}。その数を減らせ——十匹——そしてブライトに居る資格を証明しろ。',
  'entities.quests.custom_proving_ground.completion': '十匹のドレイクが倒れた。悪くない。ここで生き延びられるかもな、{playerName}。',
  'entities.quests.custom_proving_ground.objectives.0.label': '灰行きドレイクを倒す',
  'entities.quests.custom_marks_of_the_drake.title': 'ドレイクの印',
  'entities.quests.custom_marks_of_the_drake.text': 'ドレイクの鱗は板金並みに硬い、{playerName}。次の哨戒を装備するために八枚必要だ。ドレイクたちは簡単には渡さない——取れるだけ取れ。',
  'entities.quests.custom_marks_of_the_drake.completion': '八枚の鱗。これらは我々が鍛造できるどんなものより火に強い。よくやった。',
  'entities.quests.custom_marks_of_the_drake.objectives.0.label': '灰行きドレイクの鱗',
  'entities.quests.custom_into_the_blight.title': 'ブライトへ',
  'entities.quests.custom_into_the_blight.text': '焦げ翼ワイバーンが我々とダンジョンの間に巣を作っている、{playerName}。八匹を排除し、司令官の錬金術師のために心石を五個持ってくる必要がある。深いところにいるが、君なら辿り着ける。',
  'entities.quests.custom_into_the_blight.completion': '営巣地が制圧された。あの心石は思っている以上に価値がある。',
  'entities.quests.custom_into_the_blight.objectives.0.label': '焦げ翼ワイバーンを倒す',
  'entities.quests.custom_into_the_blight.objectives.1.label': '焦げ翼の心石',
  'entities.quests.custom_eye_of_the_storm.title': '嵐の目',
  'entities.quests.custom_eye_of_the_storm.text': '疫病の番人はイグナラクシスの外縁の守護者だ、{playerName}。あの生物の近くで数百年歪められた古い竜族だ。三体を倒してそのコアから疫病の残り火を持ってこい。それができれば、竜の顎に向かう準備ができている。',
  'entities.quests.custom_eye_of_the_storm.completion': '三体の番人が倒れ、残り火も手に入った。準備完了だ、{playerName}。駐屯地に戻って長老ドラクシスに話しかけろ。彼はこの瞬間を長い間待っていた。',
  'entities.quests.custom_eye_of_the_storm.objectives.0.label': '疫病の番人を倒す',
  'entities.quests.custom_eye_of_the_storm.objectives.1.label': '疫病の残り火',
  'entities.quests.custom_eternal_flame.title': '永遠の炎',
  'entities.quests.custom_eternal_flame.text': '永遠なるイグナラクシスは時代を超えて竜の顎に眠っている、{playerName}。我々の頭上のブライトは彼の息吹が形を成したものだ。竜の顎に入り、彼の巣穴で対峙し、終わらせろ。仲間が必要になる——一人での狩りではない。',
  'entities.quests.custom_eternal_flame.completion': '永遠の炎が消えた、{playerName}。三十年待ってこの言葉を言える。ブライトはやがて消えるだろう。これを取れ——十分以上に値する。',
  'entities.quests.custom_eternal_flame.objectives.0.label': '永遠なるイグナラクシスを倒す',
  'entities.quests.custom_blight_patrol.title': 'ブライト巡邏',
  'entities.quests.custom_blight_patrol.text': 'ドレイクとワイバーンに通路を制圧させるわけにはいかない、{playerName}。ブライトを巡邏し、ドレイク十五体とワイバーン八体を倒して報告に来い。指揮系統が大局を処理する間、側面を清潔に保つ。',
  'entities.quests.custom_blight_patrol.completion': '側面が安全になった。誰かが出て差を生み出しているとき、兵士たちはもっと楽に呼吸できる。よくやった、{playerName}。',
  'entities.quests.custom_blight_patrol.objectives.0.label': '灰行きドレイクを倒す',
  'entities.quests.custom_blight_patrol.objectives.1.label': '焦げ翼ワイバーンを倒す',
  'entities.zones.custom_dragons_blight.name': 'ドラゴンのブライト',
  'entities.zones.custom_dragons_blight.welcome': 'ドラゴンのブライトが前に広がる、灰と古代の炎の遠い残響に覆われている。',
  'entities.zones.custom_dragons_blight.pois.0.label': 'ブライトウォッチ駐屯地',
  'entities.zones.custom_dragons_blight.pois.1.label': 'フェンリスの前哨地',
  'entities.zones.custom_dragons_blight.pois.2.label': '竜の顎',
  'entities.dungeons.custom_dragons_maw.name': '竜の顎',
  'entities.dungeons.custom_dragons_maw.enterText': '熱気が息苦しい。前方の闇の中で何か巨大なものが動いている。',
  'entities.dungeons.custom_dragons_maw.leaveText': '竜の顎から出ると、外の空気が肌に冷たく感じられる。',
  ...
  'entities.items.custom_drake_scale.name': '灰行きドレイクの鱗',
  'entities.items.custom_wyvern_heartstone.name': '暗翼ワイバーンの心石',
  'entities.items.custom_blight_ember.name': '疫病の残り火',
  'entities.items.custom_drakebone_shoulders.name': 'ドレイク骨の肩当て',
  'entities.items.custom_scorchwing_cowl.name': '焦げ翼のカウル',
  'entities.items.custom_blight_stalkers_hood.name': '疫病の追跡者のフード',
  'entities.items.custom_ignaraxis_greatblade.name': 'イグナラクシスの大剣',
  'entities.items.custom_cinderstave_eternal.name': '永遠の灰燼の杖',
  'entities.items.custom_fang_of_ignaraxis.name': 'イグナラクシスの牙',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Eastbrookのチャンピオン',
