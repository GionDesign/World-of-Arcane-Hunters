...
function input(over: Partial<CharacterSheetInput> = {}): CharacterSheetInput {
  return {
    ...
    visibility: 'owner',
    realm: 'Claudemoon',
    origin: 'https://world.arcanehunters.com',
...
describe('characterSheet — shared fields', () => {
  it('derives classLabel, zone, virtualLevel, prestige, spec, avatar + profile urls', () => {
    ...
    expect(sheet.avatarUrl).toBe('https://world.arcanehunters.com/avatar/shaman/0.png');
    expect(sheet.profileUrl).toBe('https://world.arcanehunters.com/c/Thrallish');
