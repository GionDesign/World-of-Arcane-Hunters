...
export const guideStrings = {
  ...
  worldPage: {
    heading: 'The world',
    intro:
      'World of Arcane Hunters is one continuous land you cross on foot, three zones laid south to north. There is no fast travel, so the journey is part of the adventure.',
    hub: 'Home base',
