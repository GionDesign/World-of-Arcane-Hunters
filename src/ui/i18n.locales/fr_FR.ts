...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'Site officiel de World of Arcane Hunters',
  'seo.officialBody':
    'Le MMO gratuit officiel sur navigateur du royaume Eastbrook. Jouez en ligne avec un personnage persistant, explorez en solo hors ligne, lisez le wiki et suivez les liens communautaires vérifiés depuis ce site.',
  ...
  'playerCard.defaultRealm': 'Monde de Arcane Hunters',
  ...
  'playerCard.shareText':
    'Je forge ma légende dans World of Arcane Hunters: niveau {level} {className}{tierBit}. Rejoignez mon royaume:',
  'playerCard.nativeShareTitle': 'Monde de Arcane Hunters',
  ...
  'seo.description':
    'Partez pour une aventure épique dans World of Arcane Hunters, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.',
  'seo.genre': 'MMORPG',
  ...
  'a11y.githubProject': 'Ouvrir le projet World of Arcane Hunters sur GitHub',
  'a11y.discordCommunity': 'Rejoindre la communauté World of Arcane Hunters sur Discord',
  'a11y.donateProject': 'Faire un don pour soutenir World of Arcane Hunters',
  ...
  'mobilePreflight.iosOpenStep':
    "Ouvrez World of Arcane Hunters depuis la nouvelle icône de l'écran d'accueil.",
  ...
  'mobilePreflight.androidOpenStep': 'Ouvrez World of Arcane Hunters depuis la nouvelle icône.',
  ...
  'serverUnavailable.title': 'World of Arcane Hunters - Royaume indisponible',
  ...
  'serverUnavailable.body':
    'Nous redémarrons le service de jeu et Eastbrook devrait revenir bientôt. Cette page continuera de vérifier automatiquement.',
  ...
  // Dragon's Blight custom zone entities
  'entities.mobs.custom_ashwalker_drake.name': 'Drake Marcheur de Cendres',
  'entities.mobs.custom_scorchwing_wyvern.name': 'Wyverne Aile Roussie',
  'entities.mobs.custom_blighted_sentinel.name': 'Sentinelle Maudite',
  'entities.mobs.custom_dragonclaw_warden.name': 'Gardien Griffe de Dragon',
  'entities.mobs.custom_ignaraxis.name': "Ignaraxis l'Eternel",
  ...
  'entities.npcs.custom_commander_vael.name': 'Commandant Vael',
  'entities.npcs.custom_commander_vael.title': 'Officier de la Garde du Fleau',
  'entities.npcs.custom_commander_vael.greeting': 'Tenez-vous pret, {playerName}. Ce fleau ne dort pas, et nous non plus.',
  'entities.npcs.custom_scout_fenris.name': 'Eclaireur Fenris',
  'entities.npcs.custom_scout_fenris.title': 'Eclaireur de la Garde du Fleau',
  'entities.npcs.custom_scout_fenris.greeting': "Vous avez traverse le territoire des wyvernes ? Bien. J'avais besoin de quelqu'un de capable ici.",
  'entities.npcs.custom_elder_draxis.name': 'Aine Draxis',
  'entities.npcs.custom_elder_draxis.title': 'Tueur de dragons',
  'entities.npcs.custom_elder_draxis.greeting': "J'ai chasse les dragons pendant trente ans, {playerName}. Ignaraxis n'est pas comme les autres.",
  'entities.quests.custom_proving_ground.title': "Terrain d'epreuve",
  'entities.quests.custom_proving_ground.text': "Les drakes marcheurs de cendres ont avance jusqu'aux abords de notre camp, {playerName}. Reduisez leur nombre -- dix d'entre eux -- et prouvez que vous avez votre place dans le Fleau.",
  'entities.quests.custom_proving_ground.completion': 'Dix drakes abattus. Pas mal. Vous survivrez peut-etre ici, {playerName}.',
  'entities.quests.custom_proving_ground.objectives.0.label': 'Drakes Marcheurs de Cendres tues',
  'entities.quests.custom_marks_of_the_drake.title': 'Marques du Drake',
  'entities.quests.custom_marks_of_the_drake.text': "Les ecailles de drake sont aussi dures que de l'armure en plaques, {playerName}. J'en ai besoin de huit pour equiper la prochaine patrouille. Les drakes ne les cedent pas facilement -- prenez ce que vous pouvez.",
  'entities.quests.custom_marks_of_the_drake.completion': 'Huit ecailles. Elles resisteront au feu mieux que tout ce que nous pouvons forger. Bien joue.',
  'entities.quests.custom_marks_of_the_drake.objectives.0.label': 'Ecailles de Drake Marcheur de Cendres',
  'entities.quests.custom_into_the_blight.title': 'Au Coeur du Fleau',
  'entities.quests.custom_into_the_blight.text': "Ces wyvernes ailes roussies nichent entre nous et le donjon, {playerName}. Il faut en eliminer huit, et j'ai besoin de cinq de leurs pierres du coeur pour l'alchimiste du commandant. Elles sont en profondeur, mais je sais que vous pouvez les atteindre.",
  'entities.quests.custom_into_the_blight.completion': 'Le nid est neutralise. Ces pierres du coeur nous seront plus precieuses que vous ne le pensez.',
  'entities.quests.custom_into_the_blight.objectives.0.label': 'Wyvernes Ailes Roussies tuees',
  'entities.quests.custom_into_the_blight.objectives.1.label': 'Pierres du Coeur de Wyverne',
  'entities.quests.custom_eye_of_the_storm.title': 'Oeil de la tempete',
  'entities.quests.custom_eye_of_the_storm.text': "Les sentinelles maudites sont la garde exterieure d'Ignaraxis, {playerName}. D'anciens drakonoides deformes par des siecles aupres de cette creature. Terrassez-en trois et rapportez-moi les braises maudites de leurs noyaux. Si vous pouvez en venir a bout, vous etes prets pour la Gueule.",
  'entities.quests.custom_eye_of_the_storm.completion': "Trois sentinelles a terre, braises en main. Vous etes prets, {playerName}. Retournez au poste parler a l'Aine Draxis. Il attend ce moment depuis longtemps.",
  'entities.quests.custom_eye_of_the_storm.objectives.0.label': 'Sentinelles Maudites tuees',
  'entities.quests.custom_eye_of_the_storm.objectives.1.label': 'Braises Maudites',
  'entities.quests.custom_eternal_flame.title': 'La Flamme Eternelle',
  'entities.quests.custom_eternal_flame.text': "Ignaraxis l'Eternel dort dans la Gueule du Dragon depuis une eternite, {playerName}. Le Fleau au-dessus de nous est son souffle materialise. Entrez dans la Gueule, affrontez-le dans son repaire et mettez-y fin. Vos compagnons seront necessaires -- ce n'est pas une chasse pour un seul.",
  'entities.quests.custom_eternal_flame.completion': "La Flamme Eternelle est eteinte, {playerName}. J'ai attendu trente ans pour prononcer ces mots. Le Fleau s'estompera maintenant. Prenez ceci -- vous l'avez amplement merite.",
  'entities.quests.custom_eternal_flame.objectives.0.label': "Ignaraxis l'Eternel tue",
  'entities.quests.custom_blight_patrol.title': 'Patrouille du Fleau',
  'entities.quests.custom_blight_patrol.text': 'Nous ne pouvons pas laisser les drakes et les wyvernes envahir les approches, {playerName}. Patrouillier le Fleau, abattez quinze drakes et huit wyvernes, puis faites votre rapport. Nos flancs sont ainsi degages pendant que la chaine de commandement gere le tableau d\'ensemble.',
  'entities.quests.custom_blight_patrol.completion': 'Les flancs sont degages. Les hommes respirent plus facilement quand quelqu\'un est la a faire la difference. Bon travail, {playerName}.',
  'entities.quests.custom_blight_patrol.objectives.0.label': 'Drakes Marcheurs de Cendres tues',
  'entities.quests.custom_blight_patrol.objectives.1.label': 'Wyvernes Ailes Roussies tuees',
  'entities.zones.custom_dragons_blight.name': 'Fleau du Dragon',
  'entities.zones.custom_dragons_blight.welcome': "Le Fleau du Dragon s'etend devant vous, etouffe par la cendre et l'echo lointain d'un feu ancestral.",
  'entities.zones.custom_dragons_blight.pois.0.label': 'Poste de la Garde du Fleau',
  'entities.zones.custom_dragons_blight.pois.1.label': 'Avant-poste de Fenris',
  'entities.zones.custom_dragons_blight.pois.2.label': 'Gueule du Dragon',
  'entities.dungeons.custom_dragons_maw.name': 'Gueule du Dragon',
  'entities.dungeons.custom_dragons_maw.enterText': 'La chaleur est suffocante. Quelque chose d\'immense remue dans les tenebres devant vous.',
  'entities.dungeons.custom_dragons_maw.leaveText': 'Vous emergez de la Gueule du Dragon, l\'air exterieur frais contre votre peau.',
  ...
  'mode.play': 'Jouer',
  'mode.playAria': 'Jouer à World of Arcane Hunters',
  ...
  'entities.items.custom_drake_scale.name': 'Ecaille de Drake Cendrier',
  'entities.items.custom_wyvern_heartstone.name': 'Pierre du Coeur de Wyverne Sombre',
  'entities.items.custom_blight_ember.name': 'Braise Maudite',
  'entities.items.custom_drakebone_shoulders.name': 'Epaulieres d\'Os de Drake',
  'entities.items.custom_scorchwing_cowl.name': 'Capuche Aile Roussie',
  'entities.items.custom_blight_stalkers_hood.name': 'Capuche du Rodeur Maudit',
  'entities.items.custom_ignaraxis_greatblade.name': 'Grande Lame d\'Ignaraxis',
  'entities.items.custom_cinderstave_eternal.name': 'Baton de Cendres Eternelles',
  'entities.items.custom_fang_of_ignaraxis.name': 'Croc d\'Ignaraxis',
  ...
  'guide.worldPage.intro':
    "World of Arcane Hunters est une seule terre continue que l'on traverse à pied, trois zones disposées du sud au nord. Il n'y a pas de voyage rapide, alors le trajet fait partie de l'aventure.",
  ...
  'hudChrome.discord.swag.titleChampion': 'Titre: Champion de Eastbrook',
