...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'playerCard.defaultRealm': 'Мир Arcane Hunters',
  ...
  'playerCard.nativeShareTitle': 'Мир Arcane Hunters',
  ...
  'entities.mobs.custom_ashwalker_drake.name': 'Пепельный Дрейк',
  'entities.mobs.custom_scorchwing_wyvern.name': 'Опаленнокрылый Виверн',
  'entities.mobs.custom_blighted_sentinel.name': 'Зараженный Страж',
  'entities.mobs.custom_dragonclaw_warden.name': 'Хранитель Драконьих Когтей',
  'entities.mobs.custom_ignaraxis.name': 'Игнараксис Вечный',
  'entities.mobs.custom_skullfire_brute.name': 'Черепопламенный Громила',
  'entities.mobs.custom_blightshroud_stalker.name': 'Чумной Преследователь',
  'entities.mobs.custom_ironpelt_monkroose.name': 'Железнокожий Мункруз',
  'entities.npcs.custom_commander_vael.name': 'Командир Ваэль',
  'entities.npcs.custom_commander_vael.title': 'Офицер Стражи Гибели',
  'entities.npcs.custom_commander_vael.greeting': 'Будьте готовы, {playerName}. Эта Гибель не спит, и мы тоже.',
  'entities.npcs.custom_scout_fenris.name': 'Разведчик Фенрис',
  'entities.npcs.custom_scout_fenris.title': 'Разведчик Стражи Гибели',
  'entities.npcs.custom_scout_fenris.greeting': 'Вы прошли через территорию виvernов? Хорошо. Мне нужен кто-то умелый здесь.',
  'entities.npcs.custom_elder_draxis.name': 'Старейшина Дракcис',
  'entities.npcs.custom_elder_draxis.title': 'Охотник на Драконов',
  'entities.npcs.custom_elder_draxis.greeting': 'Я охочусь на драконов тридцать лет, {playerName}. Игнараксис не такой, как другие.',
  'entities.quests.custom_proving_ground.title': 'Испытательный Полигон',
  'entities.quests.custom_proving_ground.text': 'Пепельные Дрейки продвинулись к краям нашего лагеря, {playerName}. Проредите их ряды — убейте десять — и докажите, что вы достойны Гибели.',
  'entities.quests.custom_proving_ground.completion': 'Десять Дрейков пали. Неплохо. Возможно, вы и правда выживете здесь, {playerName}.',
  'entities.quests.custom_proving_ground.objectives.0.label': 'Пепельные Дрейки убиты',
  'entities.quests.custom_marks_of_the_drake.title': 'Знаки Дрейка',
  'entities.quests.custom_marks_of_the_drake.text': 'Чешуя Дрейков прочна, как латы, {playerName}. Мне нужно восемь штук, чтобы снарядить следующий патруль. Дрейки не отдают их легко — берите, что можете.',
  'entities.quests.custom_marks_of_the_drake.completion': 'Восемь чешуй. Они выдержат огонь лучше всего, что мы можем выковать. Отличная работа.',
  'entities.quests.custom_marks_of_the_drake.objectives.0.label': 'Чешуя Пепельного Дрейка',
  'entities.quests.custom_into_the_blight.title': 'В Глубь Гибели',
  'entities.quests.custom_into_the_blight.text': 'Эти Опаленнокрылые Вивернь вьют гнезда между нами и подземельем, {playerName}. Нужно уничтожить восемь из них, и мне нужно пять их сердечных камней для алхимика командира. Они прячутся глубоко, но я знаю, что вы доберетесь.',
  'entities.quests.custom_into_the_blight.completion': 'Гнездовище расчищено. Эти сердечные камни окажутся ценнее, чем вы думаете.',
  'entities.quests.custom_into_the_blight.objectives.0.label': 'Опаленнокрылые Вивернь убиты',
  'entities.quests.custom_into_the_blight.objectives.1.label': 'Сердечные Камни Опаленнокрылых',
  'entities.quests.custom_eye_of_the_storm.title': 'Глаз Бури',
  'entities.quests.custom_eye_of_the_storm.text': 'Зараженные Стражи — внешняя охрана Игнараксиса, {playerName}. Древние драконорожденные, искаженные веками рядом с этим существом. Повергните трех и принесите мне мерцающие угольки из их сердцевины. Если справитесь с ними, вы готовы к Пасти.',
  'entities.quests.custom_eye_of_the_storm.completion': 'Три стража пали, и угольки в руках. Вы готовы, {playerName}. Возвращайтесь на пост и поговорите со Старейшиной Дракcисом. Он долго ждал этого момента.',
  'entities.quests.custom_eye_of_the_storm.objectives.0.label': 'Зараженные Стражи убиты',
  'entities.quests.custom_eye_of_the_storm.objectives.1.label': 'Губительные Угольки',
  'entities.quests.custom_eternal_flame.title': 'Вечное Пламя',
  'entities.quests.custom_eternal_flame.text': 'Игнараксис Вечный дремлет в Драконьей Пасти целую эпоху, {playerName}. Гибель над нами — это его дыхание, принявшее форму. Войдите в Пасть, встретьте его в логове и покончите с этим. Ваши товарищи будут необходимы — это не охота для одного.',
  'entities.quests.custom_eternal_flame.completion': 'Вечное Пламя угасло, {playerName}. Я ждал тридцать лет, чтобы сказать эти слова. Гибель теперь рассеется. Возьмите это — вы заслужили.',
  'entities.quests.custom_eternal_flame.objectives.0.label': 'Игнараксис Вечный убит',
  'entities.quests.custom_blight_patrol.title': 'Патруль Гибели',
  'entities.quests.custom_blight_patrol.text': 'Мы не можем позволить Дрейкам и Виvernям захватить подходы, {playerName}. Патрулируйте Гибель, уничтожьте пятнадцать Дрейков и восемь Виvernей, затем доложите. Держите наши фланги чистыми, пока командование разбирается с большой картиной.',
  'entities.quests.custom_blight_patrol.completion': 'Фланги в безопасности. Солдаты дышат легче, когда кто-то выходит и что-то делает. Отличная работа, {playerName}.',
  'entities.quests.custom_blight_patrol.objectives.0.label': 'Пепельные Дрейки убиты',
  'entities.quests.custom_blight_patrol.objectives.1.label': 'Опаленнокрылые Вивернь убиты',
  'entities.zones.custom_dragons_blight.name': 'Драконья Гибель',
  'entities.zones.custom_dragons_blight.welcome': 'Драконья Гибель простирается перед вами, задушенная пеплом и далеким эхом древнего огня.',
  'entities.zones.custom_dragons_blight.pois.0.label': 'Пост Стражи Гибели',
  'entities.zones.custom_dragons_blight.pois.1.label': 'Аванпост Фенриса',
  'entities.zones.custom_dragons_blight.pois.2.label': 'Драконья Пасть',
  'entities.dungeons.custom_dragons_maw.name': 'Драконья Пасть',
  'entities.dungeons.custom_dragons_maw.enterText': 'Жара невыносима. Что-то огромное шевелится во тьме впереди.',
  'entities.dungeons.custom_dragons_maw.leaveText': 'Вы выходите из Драконьей Пасти, наружный воздух холодит кожу.',
  ...
  'entities.items.custom_drake_scale.name': 'Чешуя Пепельного Дрейка',
  'entities.items.custom_wyvern_heartstone.name': 'Сердечный Камень Темнокрылого Виверна',
  'entities.items.custom_blight_ember.name': 'Губительный Уголек',
  'entities.items.custom_drakebone_shoulders.name': 'Наплечники из Костей Дрейка',
  'entities.items.custom_scorchwing_cowl.name': 'Капюшон Опаленнокрылого',
  'entities.items.custom_blight_stalkers_hood.name': 'Капюшон Губительного Охотника',
  'entities.items.custom_ignaraxis_greatblade.name': 'Великий Клинок Игнараксиса',
  'entities.items.custom_cinderstave_eternal.name': 'Посох Вечного Пепла',
  'entities.items.custom_fang_of_ignaraxis.name': 'Клык Игнараксиса',
  ...
  'hudChrome.discord.swag.titleChampion': 'Титул: Чемпион Eastbrook',
