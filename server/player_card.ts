...
// Keys are matched against a lowercased incoming Host header (see
// trustedPublicOriginFromHost), so they must stay lowercase even though the
// placeholder domain elsewhere in the codebase is written mixed-case.
const TRUSTED_PUBLIC_HOST_ORIGINS = new Map([
  ...
  ['dev.todo-your-domain.com', 'https://dev.todo-your-domain.com'],
]);
...
export const PUBLIC_CARD_COPY: Record<PublicCardLocale, PublicCardCopy> = {
  en: {
    ...
    description: '{name} is forging a legend in World of Arcane Hunters. Join the realm.',
    ...
    missingCta: 'Enter World of Arcane Hunters',
    classes: EN_CLASSES,
  },
  es: {
    gameName: 'World of Arcane Hunters',
    ...
    description: '{name} está forjando una leyenda en World of Arcane Hunters. Únete al reino.',
    ...
    missingCta: 'Entrar en World of Arcane Hunters',
    classes: {
      warrior: 'Guerrero',
      paladin: 'Paladín',
      hunter: 'Cazador',
  ...
  fr_FR: {
    ...
    description: '{name} forge sa légende dans World of Arcane Hunters. Rejoignez le royaume.',
    ...
    missingCta: 'Entrer dans World of Arcane Hunters',
    classes: {
      warrior: 'Guerrier',
      paladin: 'Paladin',
      hunter: 'Chasseur',
  ...
  it_IT: {
    ...
    description: '{name} sta forgiando una leggenda in World of Arcane Hunters. Entra nel reame.',
    ...
    missingCta: 'Entra in World of Arcane Hunters',
    classes: {
      warrior: 'Guerriero',
      paladin: 'Paladino',
      hunter: 'Cacciatore',
  ...
  de_DE: {
    ...
    description: '{name} schmiedet eine Legende in World of Arcane Hunters. Betretet das Reich.',
    ...
    missingCta: 'World of Arcane Hunters betreten',
    classes: {
      warrior: 'Krieger',
      paladin: 'Paladin',
      hunter: 'Jäger',
  ...
  zh_CN: {
    ...
    description: '{name} 正在 World of Arcane Hunters 中铸就传奇。加入这个国度。',
    cta: '铸就你的传奇',
    missingTitle: '未找到卡片',
    missingHeading: '这张卡片已不可用。',
    missingDescription: '它可能已被撤下，或从未存在。',
    missingCta: '进入 World of Arcane Hunters',
    classes: {
      warrior: '战士',
      paladin: '圣骑士',
      hunter: '猎人',
  ...
  zh_TW: {
    ...
    description: '{name} 正在 World of Arcane Hunters 中鑄就傳奇。加入這個國度。',
    cta: '鑄就你的傳奇',
    missingTitle: '找不到卡片',
    missingHeading: '這張卡片已不可用。',
    missingDescription: '它可能已被移除，或從未存在。',
    missingCta: '進入 World of Arcane Hunters',
    classes: {
      warrior: '戰士',
      paladin: '聖騎士',
      hunter: '獵人',
  ...
  ja_JP: {
    ...
    description: '{name} は World of Arcane Hunters で伝説を築いています。王国に参加しましょう。',
    cta: '自分の伝説を築く',
    missingTitle: 'カードが見つかりません',
    missingHeading: 'このカードは現在利用できません。',
    missingDescription: '削除されたか、存在しなかった可能性があります。',
    missingCta: 'World of Arcane Hunters に入る',
    classes: {
      warrior: '戦士',
      paladin: 'パラディン',
      hunter: 'ハンター',
  ...
  pt_BR: {
    ...
    description: '{name} está forjando uma lenda em World of Arcane Hunters. Entre no reino.',
    cta: 'Forje sua lenda',
    ...
    missingCta: 'Entrar em World of Arcane Hunters',
    classes: {
      warrior: 'Guerreiro',
      paladin: 'Paladino',
      hunter: 'Caçador',
  ...
  ru_RU: {
    ...
    description: '{name} создает легенду в World of Arcane Hunters. Присоединяйтесь к миру.',
    ...
    missingCta: 'Войти в World of Arcane Hunters',
    classes: {
      warrior: 'Воин',
      paladin: 'Паладин',
      hunter: 'Охотник',
