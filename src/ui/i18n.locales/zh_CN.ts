...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.mobs.custom_magma_hound.name": "岩浆猎犬",
  ...
  "entities.npcs.custom_warden_cael.name": "守护者卡尔",
  "entities.npcs.custom_warden_cael.title": "余烬哨站指挥官",
  "entities.npcs.custom_warden_cael.greeting": "炽焰坑每时每刻都愈发危险。我们需要每一双能干的手。",
  "entities.quests.custom_q_quench_the_elementals.title": "镇压元素",
  "entities.quests.custom_q_quench_the_elementals.text": "熔岩元素正从裂缝中涌出，切断了我们的补给线。消灭10只并带回5个余烬核心作为证明。小心——它们濒死时会喷发热浪。",
  "entities.quests.custom_q_quench_the_elementals.completion": "干得好。裂缝似乎暂时平静下来了。这些核心对我们的工匠或许有用。",
  "entities.quests.custom_q_quench_the_elementals.objectives.0.label": "消灭的熔岩元素",
  "entities.quests.custom_q_quench_the_elementals.objectives.1.label": "收集的余烬核心",
  "entities.quests.custom_q_hound_culling.title": "猎犬种群",
  "entities.quests.custom_q_hound_culling.text": "岩浆猎犬一直在西部山脊游荡并袭击我们的斥候。消灭8只并收集它们的毛皮。这种皮质耐火——我们可以用来修补铠甲。",
  "entities.quests.custom_q_hound_culling.completion": "这些毛皮很不错。我们的皮革匠会在下次巡逻前将它们处理好。",
  "entities.quests.custom_q_hound_culling.objectives.0.label": "击杀的岩浆猎犬",
  "entities.quests.custom_q_hound_culling.objectives.1.label": "岩浆猎犬毛皮",
  "entities.quests.custom_q_troll_tide.title": "巨魔潮",
  "entities.quests.custom_q_troll_tide.text": "煤渣巨魔正在北部集结。他们占据了古老的火焰神祠，我们不能让他们守住它。杀死6只煤渣巨魔，并带回4根他们的獠牙作为战利品。",
  "entities.quests.custom_q_troll_tide.completion": "神祠再度归我们所有。干得好。",
  "entities.quests.custom_q_troll_tide.objectives.0.label": "击杀的煤渣巨魔",
  "entities.quests.custom_q_troll_tide.objectives.1.label": "煤渣巨魔獠牙",
  "entities.zones.custom_cinderhold.name": "炽焰坑",
  "entities.zones.custom_cinderhold.welcome": "烟雾散去之前，热浪已先行来袭。欢迎来到炽焰坑。",
  "entities.zones.custom_cinderhold.pois.0.label": "余烬哨站",
  "entities.zones.custom_cinderhold.pois.1.label": "西部山脊",
  "entities.zones.custom_cinderhold.pois.2.label": "灰烬神祠",
  "entities.zones.custom_cinderhold.pois.3.label": "巨人巢穴",
  // Cinderhold custom items
  "entities.items.custom_ember_core.name": "炽热灰烬核心",
  "entities.items.custom_magma_pelt.name": "焦烤熔岩猎犬毛皮",
  "entities.items.custom_cinder_tusk.name": "煤渣巨魔獠牙",
  "entities.items.custom_slag_fragment.name": "炉渣碎片",
  "entities.items.custom_ash_bone.name": "灰烬骸骨",
  "entities.items.custom_blaze_reaver.name": "烈焰巨刃",
  "entities.items.custom_inferno_staff.name": "地狱法杖",
  "entities.items.custom_cinderfang_dagger.name": "焰牙匕首",
  "entities.items.custom_fire_resistance_potion.name": "火焰抵抗药水",
  "entities.items.custom_charred_ration.name": "炭化野战口粮",
};
