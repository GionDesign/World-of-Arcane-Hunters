...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialLabel': 'World of Arcane Hunters 官方网站',
  'seo.officialBody':
    'Eastbrook 服务器的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'playerCard.defaultRealm': 'Arcane Hunters 世界',
  ...
  'playerCard.shareText':
    '我正在 World of Arcane Hunters 中铸就传说：{level}级 {className}{tierBit}。加入我的服务器：',
  'playerCard.nativeShareTitle': 'Arcane Hunters 世界',
  ...
  'controls.chat': '打开聊天框',
  'seo.title': 'World of Arcane Hunters：经典风格网页 MMO',
  'seo.description':
    '在 World of Arcane Hunters 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。',
  'seo.genre': 'MMORPG',
  'seo.playMode': '多人游戏',
  ...
  'a11y.githubProject': '打开 World of Arcane Hunters 的 GitHub 项目',
  'a11y.discordCommunity': '加入 World of Arcane Hunters 的 Discord 社区',
  'a11y.donateProject': '捐赠支持 World of Arcane Hunters',
  ...
  'mobilePreflight.iosOpenStep': '从新的主屏幕图标打开 World of Arcane Hunters。',
  ...
  'entities.mobs.custom_ashwalker_drake.name': '灰行德雷克',
  'entities.mobs.custom_scorchwing_wyvern.name': '焦翼翼龙',
  'entities.mobs.custom_blighted_sentinel.name': '腐蚀哨兵',
  'entities.mobs.custom_dragonclaw_warden.name': '龙爪守卫',
  'entities.mobs.custom_ignaraxis.name': '永恒的伊格纳拉克斯',
  'entities.mobs.custom_skullfire_brute.name': '颅焰蛮兵',
  'entities.mobs.custom_blightshroud_stalker.name': '瘟雾潜袭者',
  'entities.mobs.custom_ironpelt_monkroose.name': '铁皮僧鼬',
  'entities.npcs.custom_commander_vael.name': '瓦尔指挥官',
  'entities.npcs.custom_commander_vael.title': '腐蚀之地军官',
  'entities.npcs.custom_commander_vael.greeting': '做好准备，{playerName}。这片腐蚀之地不曾入眠，我们也不会。',
  'entities.npcs.custom_scout_fenris.name': '侦察员芬里斯',
  'entities.npcs.custom_scout_fenris.title': '腐蚀之地侦察员',
  'entities.npcs.custom_scout_fenris.greeting': '你穿越了翼龙地带？很好。我需要像你这样有能力的人。',
  'entities.npcs.custom_elder_draxis.name': '长老德拉克西斯',
  'entities.npcs.custom_elder_draxis.title': '屠龙者',
  'entities.npcs.custom_elder_draxis.greeting': '我猎龙已三十年，{playerName}。伊格纳拉克斯与众不同。',
  'entities.quests.custom_proving_ground.title': '证明之地',
  'entities.quests.custom_proving_ground.text': '灰行德雷克已推进到我们营地边缘，{playerName}。削减它们的数量——杀死十只——证明你属于腐蚀之地。',
  'entities.quests.custom_proving_ground.completion': '十只德雷克倒下了。不错。你或许真能在这里活下去，{playerName}。',
  'entities.quests.custom_proving_ground.objectives.0.label': '击杀灰行德雷克',
  'entities.quests.custom_marks_of_the_drake.title': '德雷克的印记',
  'entities.quests.custom_marks_of_the_drake.text': '德雷克鳞片坚硬如板甲，{playerName}。我需要八片来装备下一支巡逻队。德雷克们不会轻易放手——能取多少就取多少。',
  'entities.quests.custom_marks_of_the_drake.completion': '八片鳞片。这些比我们能锻造的任何东西都更耐火。干得好。',
  'entities.quests.custom_marks_of_the_drake.objectives.0.label': '灰行德雷克鳞片',
  'entities.quests.custom_into_the_blight.title': '进入腐蚀之地',
  'entities.quests.custom_into_the_blight.text': '那些焦翼翼龙正在我们和地下城之间筑巢，{playerName}。需要消灭八只，同时我需要五颗它们的心石给指挥官的炼金师。它们躲得很深，但我知道你能找到它们。',
  'entities.quests.custom_into_the_blight.completion': '巢穴已清除。那些心石将比你想象的对我们更有价值。',
  'entities.quests.custom_into_the_blight.objectives.0.label': '击杀焦翼翼龙',
  'entities.quests.custom_into_the_blight.objectives.1.label': '焦翼心石',
  'entities.quests.custom_eye_of_the_storm.title': '风暴之眼',
  'entities.quests.custom_eye_of_the_storm.text': '腐蚀哨兵是伊格纳拉克斯的外围守卫，{playerName}。古老的龙族在那生物附近被数百年扭曲了。击倒三只，带来它们核心中的腐蚀余烬。如果你能对付它们，你就准备好进入龙颚了。',
  'entities.quests.custom_eye_of_the_storm.completion': '三只哨兵倒下，余烬在手。你准备好了，{playerName}。回到驻地去找长老德拉克西斯。他等待这一刻已经很久了。',
  'entities.quests.custom_eye_of_the_storm.objectives.0.label': '击杀腐蚀哨兵',
  'entities.quests.custom_eye_of_the_storm.objectives.1.label': '腐蚀余烬',
  'entities.quests.custom_eternal_flame.title': '永恒之焰',
  'entities.quests.custom_eternal_flame.text': '永恒的伊格纳拉克斯在龙颚中沉睡了数个时代，{playerName}。我们头顶的腐蚀之地就是他的呼吸具象化的形态。进入龙颚，在他的巢穴中面对他，终结这一切。你的同伴将是必要的——这不是一个人的狩猎。',
  'entities.quests.custom_eternal_flame.completion': '永恒之焰已熄灭，{playerName}。我等待三十年才能说出这些话。腐蚀之地将会消退。拿着这个——你绝对值得。',
  'entities.quests.custom_eternal_flame.objectives.0.label': '击杀永恒的伊格纳拉克斯',
  'entities.quests.custom_blight_patrol.title': '腐蚀之地巡逻',
  'entities.quests.custom_blight_patrol.text': '我们不能让德雷克和翼龙淹没通道，{playerName}。巡逻腐蚀之地，击杀十五只德雷克和八只翼龙，然后回来报告。确保我们的侧翼安全，同时让指挥系统处理更大的局面。',
  'entities.quests.custom_blight_patrol.completion': '侧翼安全。当有人出去发挥作用时，士兵们呼吸更畅快。干得好，{playerName}。',
  'entities.quests.custom_blight_patrol.objectives.0.label': '击杀灰行德雷克',
  'entities.quests.custom_blight_patrol.objectives.1.label': '击杀焦翼翼龙',
  'entities.zones.custom_dragons_blight.name': '龙之腐蚀之地',
  'entities.zones.custom_dragons_blight.welcome': '龙之腐蚀之地在你面前延伸，被灰烬和远古火焰的回声所笼罩。',
  'entities.zones.custom_dragons_blight.pois.0.label': '腐蚀之地哨所',
  'entities.zones.custom_dragons_blight.pois.1.label': '芬里斯前哨',
  'entities.zones.custom_dragons_blight.pois.2.label': '龙颚',
  'entities.dungeons.custom_dragons_maw.name': '龙颚',
  'entities.dungeons.custom_dragons_maw.enterText': '热浪令人窒息。前方的黑暗中有庞大的东西在蠕动。',
  'entities.dungeons.custom_dragons_maw.leaveText': '你从龙颚中走出，外面的空气冰冷地拂过皮肤。',
  ...
  'mode.play': '开始游戏',
  'mode.playAria': '开始游玩 World of Arcane Hunters',
  ...
  'entities.items.custom_drake_scale.name': '灰行蜉蝣鳞',
  'entities.items.custom_wyvern_heartstone.name': '暗翼翼龙心石',
  'entities.items.custom_blight_ember.name': '腐蚀余烬',
  'entities.items.custom_drakebone_shoulders.name': '蜉蝣龙骨护肩',
  'entities.items.custom_scorchwing_cowl.name': '焦翼兜帽',
  'entities.items.custom_blight_stalkers_hood.name': '腐蚀猎手头巾',
  'entities.items.custom_ignaraxis_greatblade.name': '伊格纳拉克斯巨刃',
  'entities.items.custom_cinderstave_eternal.name': '永恒灰烬法杖',
  'entities.items.custom_fang_of_ignaraxis.name': '伊格纳拉克斯之牙',
  ...
  'guide.worldPage.intro':
    'World of Arcane Hunters 是一片连绵不绝、需你徒步穿越的大陆，三大区域由南向北依次铺展。这里没有快速旅行，因此旅途本身便是冒险的一部分。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Eastbrook 勇士',
