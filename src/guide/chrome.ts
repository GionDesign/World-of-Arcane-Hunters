    ...
    <footer class="guide-footer">
      <div class="guide-footer-inner">
        ...
        <nav class="guide-footer-links" aria-label="${esc(t('guide.footer.rights'))}">
          ...
          <a href="https://github.com/giondesign/world-of-arcane-hunters" target="_blank" rel="noopener">${esc(t('guide.footer.github'))}</a>
          <a href="https://discord.gg/TODO" target="_blank" rel="noopener">${esc(t('guide.footer.discord'))}</a>
        </nav>
