...
export const es_ES: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.description':
    'Emprende una aventura épica en World of Arcane Hunters, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.',
  'a11y.goHome': 'Ir a la página de inicio',
  'a11y.characterActions': 'Acciones del personaje',
  'a11y.githubProject': 'Abrir el proyecto World of Arcane Hunters en GitHub',
