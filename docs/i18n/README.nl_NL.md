...
**Officiële website: https://world.arcanehunters.com/**
...
[Speel nu](https://world.arcanehunters.com/) · [Host je eigen wereld](#host-your-own-world-one-command) · [Train een agent](#train-an-agent-headless-rl) · [Web3](#web3) · [Bijdragen](CONTRIBUTING.nl_NL.md) · [Discord](https://discord.gg/GjhnUsBtw)
...
World of ClaudeCraft is een complete MMO uit het klassieke tijdperk die je nu meteen in je browser kunt spelen, zelf met één commando kunt hosten en zelfs door AI-agents kunt laten spelen. Het is gratis, open source en live op [world.arcanehunters.com](https://world.arcanehunters.com/).
...
Meer over de token op [world.arcanehunters.com](https://world.arcanehunters.com/).
