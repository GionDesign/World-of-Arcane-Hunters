...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'a11y.discordCommunity': 'Deltag i World of Arcane Hunters Discord-fællesskabet',
  'a11y.donateProject': 'Donér for at støtte World of Arcane Hunters',
  'a11y.githubProject': 'Åbn World of Arcane Hunters GitHub-projektet',
  ...
  'guide.worldPage.intro':
    'World of Arcane Hunters er ét sammenhængende land, du krydser til fods, tre zoner lagt fra syd til nord. Der er ingen hurtigrejse, så rejsen er en del af eventyret.',
  ...
  'mobilePreflight.androidOpenStep': 'Åbn World of Arcane Hunters fra det nye ikon.',
  ...
  'mobilePreflight.iosOpenStep': 'Åbn World of Arcane Hunters fra det nye ikon på startskærmen.',
  ...
  'mode.play': 'Spil',
  'mode.playAria': 'Spil World of Arcane Hunters',
  ...
  'playerCard.shareText':
    'Jeg smeder min legende i World of Arcane Hunters: Niveau {level} {className}{tierBit}. Slut dig til mit rige:',
  ...
  'seo.description':
    'Begiv dig ud på et episk eventyr i World of Arcane Hunters, en klassisk-inspireret micro-MMO, der kan spilles direkte i din browser. Slut dig til et vedvarende delt rige, lev op dine klasser, og besejr fjender!',
  'seo.genre': 'MMORPG',
  'seo.officialLabel': 'Officiel World of Arcane Hunters-hjemmeside',
  'seo.operatingSystem': 'Webbrowser',
  'seo.playMode': 'Flerspiller',
  'seo.title': 'World of Arcane Hunters: Klassisk-inspireret web-MMO',
  'serverUnavailable.body':
    'Vi genstarter spiltjenesten og forventer, at Eastbrook vender tilbage om kort tid. Denne side bliver ved med at tjekke automatisk.',
  ...
  'serverUnavailable.title': 'World of Arcane Hunters - Realm utilgængeligt',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion af Eastbrook',
